        ...
        public static int NewGore(Vector2 Position, Vector2 Velocity, int Type)
        {
            ...
            else
            {
                ...
                if (num != 200)
                {
                    ...
                    Gore expr_AB_cp_0 = Main.gore[num];
                    expr_AB_cp_0.velocity.Y = expr_AB_cp_0.velocity.Y - (float)Main.rand.Next(10, 31) * 0.1f;
                    Gore expr_D8_cp_0 = Main.gore[num];
                    expr_D8_cp_0.velocity.X = expr_D8_cp_0.velocity.X + (float)Main.rand.Next(-20, 21) * 0.1f;
