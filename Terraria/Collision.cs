            ...
            for (int i = num; i < maxTilesX; i++)
            {
                for (int j = num3; j < maxTilesY; j++)
                {
                    if ((Main.tile[i, j] != null) && Main.tile[i, j].active)
                    {
                        ...
                        vector5.X = i * 0x10;
                        vector5.Y = j * 0x10;
                        if ((((vector3.X + Width) > vector5.X) && (vector3.X < (vector5.X + 16f))) && (((vector3.Y + Height) > vector5.Y) && (vector3.Y < (vector5.Y + 16f))))
                        {
                            if ((vector4.Y + Height) <= vector5.Y)
                            {
                                num7 = i;
                                num8 = j;
                                if (num7 != num5)
                                {
                                    vector.Y = vector5.Y - (vector4.Y + Height);
                                }
                            }
                            else if (((vector4.X + Width) <= vector5.X) && !Main.tileSolidTop[Main.tile[i, j].type])
                            {
                                num5 = i;
                                num6 = j;
                                if (num6 != num8)
                                {
                                    vector.X = vector5.X - (vector4.X + Width);
                                }
                                if (num7 == num5)
                                {
                                    vector.Y = vector2.Y;
                            ...
                            else if ((vector4.X >= (vector5.X + 16f)) && !Main.tileSolidTop[Main.tile[i, j].type])
                            {
                                ...
                                if (num6 != num8)
                                {
                                    vector.X = (vector5.X + 16f) - vector4.X;
                                }
                                if (num7 == num5)
                                {
                                    vector.Y = vector2.Y;
                            ...
                            else if ((vector4.Y >= (vector5.Y + 16f)) && !Main.tileSolidTop[Main.tile[i, j].type])
                            {
                                num7 = i;
                                num8 = j;
                                vector.Y = ((vector5.Y + 16f) - vector4.Y) + 0.01f;
                                if (num8 == num6)
                                {
            ...
            for (int i = num3; i < maxTilesX; i++)
            {
                for (int j = num5; j < maxTilesY; j++)
                {
                    if ((Main.tile[i, j] != null) && (Main.tile[i, j].liquid > 0))
                    {
                        ...
                        vector2.Y += num10 * 2f;
                        num9 -= (int) (num10 * 2f);
                        if ((((vector.X + num) > vector2.X) && (vector.X < (vector2.X + 16f))) && (((vector.Y + num2) > vector2.Y) && (vector.Y < (vector2.Y + num9))))
                        {
                            return true;
                        }
                    }
