    ...
    internal class WorldGen
    {
                ...
                if (Main.tile[i, k].active && Main.tileSolid[Main.tile[i, k].type])
                {
                    ...
                    while (num5 == 0)
                    {
                        ...
                        if (genRand.Next(2) == 0)
                        {
                            ...
                            Main.chest[index].item[num5].stack = num7;
                            num5++;
                        }
                        if (genRand.Next(2) == 0)
                        {
                            int num8 = genRand.Next(2);
                            int num9 = genRand.Next(0x1a) + 0x19;
                            switch (num8)
                            {
                                case 0:
                            ...
                            Main.chest[index].item[num5].stack = num9;
                            num5++;
                        }
                        if (genRand.Next(2) == 0)
                        {
                            int num10 = genRand.Next(1);
                            int num11 = genRand.Next(3) + 3;
                            if (num10 == 0)
                            {
                                Main.chest[index].item[num5].SetDefaults(0x1c);
                            }
                            Main.chest[index].item[num5].stack = num11;
                            num5++;
                        }
                        if (genRand.Next(2) == 0)
                        {
                            int num12 = genRand.Next(2);
                            int num13 = genRand.Next(11) + 10;
                            switch (num12)
                            {
                                case 0:
                            ...
                            Main.chest[index].item[num5].stack = num13;
                            num5++;
                        }
                        if (genRand.Next(2) == 0)
                        {
        ...
        public static void CaveOpenater(int i, int j)
        {
            ...
            while (num4 > 0)
            {
                ...
                int maxTilesX = (int) (vector.X + (num * 0.5));
                int num7 = (int) (vector.Y - (num * 0.5));
                int maxTilesY = (int) (vector.Y + (num * 0.5));
                if (num5 < 0)
                {
                    num5 = 0;
                }
                ...
                for (int k = num5; k < maxTilesX; k++)
                {
                    for (int m = num7; m < maxTilesY; m++)
                    {
                        float num11 = Math.Abs((float) (k - vector.X));
                        float num12 = Math.Abs((float) (m - vector.Y));
                        if (Math.Sqrt((double) ((num11 * num11) + (num12 * num12))) < (num2 * 0.4))
                        {
        ...
        public static void ChasmRunner(int i, int j, int steps, bool makeOrb = false)
        {
            ...
            while (num3 > 0.0)
            {
                ...
                if (num > num2)
                {
                    ...
                    num6 = (int) (vector.X + (num3 * 0.5));
                    num5 = (int) (vector.Y - (num3 * 0.5));
                    maxTilesY = (int) (vector.Y + (num3 * 0.5));
                    if (num4 < 0)
                    {
                        num4 = 0;
                    }
                    ...
                    for (int n = num4; n < num6; n++)
                    {
                        for (int num9 = num5; num9 < maxTilesY; num9++)
                        {
                            if ((Math.Abs((float) (n - vector.X)) + Math.Abs((float) (num9 - vector.Y))) < ((num3 * 0.5) * (1.0 + (genRand.Next(-10, 11) * 0.015))))
                            {
                ...
                num6 = (int) (vector.X + (num3 * 1.1));
                num5 = (int) (vector.Y - (num3 * 1.1));
                maxTilesY = (int) (vector.Y + (num3 * 1.1));
                if (num4 < 1)
                {
                    num4 = 1;
                }
                ...
                {
                    for (int num14 = num5; num14 < maxTilesY; num14++)
                    {
                        if ((Math.Abs((float) (k - vector.X)) + Math.Abs((float) (num14 - vector.Y))) < ((num3 * 1.1) * (1.0 + (genRand.Next(-10, 11) * 0.015))))
                        {
                ...
                {
                    for (int num16 = num5; num16 < maxTilesY; num16++)
                    {
                        if ((Math.Abs((float) (m - vector.X)) + Math.Abs((float) (num16 - vector.Y))) < ((num3 * 1.1) * (1.0 + (genRand.Next(-10, 11) * 0.015))))
                        {
        ...
        public static void CheckPot(int i, int j, int type = 0x1c)
        {
            if (!destroyObject)
            {
                ...
                if (flag)
                {
                    ...
                    Gore.NewGore(new Vector2((float) (i * 0x10), (float) (j * 0x10)), velocity, 0x33);
                    velocity = new Vector2();
                    Gore.NewGore(new Vector2((float) (i * 0x10), (float) (j * 0x10)), velocity, 0x34);
        ...
        public static void DungeonEnt(int i, int j, int tileType, int wallType)
        {
            ...
            int num4 = ((int) (vector.X - (num * 0.60000002384185791))) - genRand.Next(2, 5);
            int maxTilesX = ((int) (vector.X + (num * 0.60000002384185791))) + genRand.Next(2, 5);
            int num6 = ((int) (vector.Y - (num2 * 0.60000002384185791))) - genRand.Next(2, 5);
            int maxTilesY = ((int) (vector.Y + (num2 * 0.60000002384185791))) + genRand.Next(8, 0x10);
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int k = num4; k < maxTilesX; k++)
            {
                for (int num9 = num6; num9 < maxTilesY; num9++)
                {
                    Main.tile[k, num9].liquid = 0;
                    if (Main.tile[k, num9].wall != wallType)
                    {
                        Main.tile[k, num9].wall = 0;
                        if (((k > (num4 + 1)) && (k < (maxTilesX - 2))) && ((num9 > (num6 + 1)) && (num9 < (maxTilesY - 2))))
                        {
            ...
            int num10 = num4;
            int num11 = (num4 + 5) + genRand.Next(4);
            int num12 = (num6 - 3) - genRand.Next(3);
            int num13 = num6;
            ...
            int num20 = 0;
            for (int num21 = num4; num21 < maxTilesX; num21++)
            {
                for (int num22 = num6 - num18; num22 < num6; num22++)
                {
            ...
            for (int num23 = num4; num23 < maxTilesX; num23++)
            {
            ...
            num4 = (int) (vector.X - (num * 0.60000002384185791));
            maxTilesX = (int) (vector.X + (num * 0.60000002384185791));
            num6 = (int) (vector.Y - (num2 * 0.60000002384185791));
            maxTilesY = (int) (vector.Y + (num2 * 0.60000002384185791));
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int num25 = num4; num25 < maxTilesX; num25++)
            {
                for (int num26 = num6; num26 < maxTilesY; num26++)
                {
                    PlaceWall(num25, num26, wallType, true);
                }
            }
            num4 = (int) ((vector.X - (num * 0.6)) - 1.0);
            maxTilesX = (int) ((vector.X + (num * 0.6)) + 1.0);
            num6 = (int) ((vector.Y - (num2 * 0.6)) - 1.0);
            maxTilesY = (int) ((vector.Y + (num2 * 0.6)) + 1.0);
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int num27 = num4; num27 < maxTilesX; num27++)
            {
                for (int num28 = num6; num28 < maxTilesY; num28++)
                {
                    Main.tile[num27, num28].wall = (byte) wallType;
                }
            }
            num4 = (int) (vector.X - (num * 0.5));
            maxTilesX = (int) (vector.X + (num * 0.5));
            num6 = (int) (vector.Y - (num2 * 0.5));
            maxTilesY = (int) (vector.Y + (num2 * 0.5));
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int num29 = num4; num29 < maxTilesX; num29++)
            {
                for (int num30 = num6; num30 < maxTilesY; num30++)
                {
            ...
            numDPlats++;
            vector.X += (((float) num) * 0.6f) * num3;
            vector.Y += ((float) num2) * 0.5f;
            num = dxStrength2;
            num2 = dyStrength2;
            vector.X += (((float) num) * 0.55f) * num3;
            vector.Y -= ((float) num2) * 0.5f;
            num4 = ((int) (vector.X - (num * 0.60000002384185791))) - genRand.Next(1, 3);
            maxTilesX = ((int) (vector.X + (num * 0.60000002384185791))) + genRand.Next(1, 3);
            num6 = ((int) (vector.Y - (num2 * 0.60000002384185791))) - genRand.Next(1, 3);
            maxTilesY = ((int) (vector.Y + (num2 * 0.60000002384185791))) + genRand.Next(6, 0x10);
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int num31 = num4; num31 < maxTilesX; num31++)
            {
                for (int num32 = num6; num32 < maxTilesY; num32++)
                {
                    if (Main.tile[num31, num32].wall != wallType)
                    {
                        ...
                        if (num3 < 0)
                        {
                            if (num31 < (vector.X - (num * 0.5)))
                            {
                                flag = false;
                            }
                        }
                        else if (num31 > ((vector.X + (num * 0.5)) - 1.0))
                        {
                            flag = false;
                        }
                        if (flag)
            ...
            for (int num33 = num4; num33 < maxTilesX; num33++)
            {
            ...
            for (int num39 = num4 + 1; num39 < (maxTilesX - 1); num39++)
            {
                for (int num40 = num6 - num18; num40 < num6; num40++)
                {
            ...
            num4 = (int) (vector.X - (num * 0.6));
            maxTilesX = (int) (vector.X + (num * 0.6));
            num6 = (int) (vector.Y - (num2 * 0.6));
            maxTilesY = (int) (vector.Y + (num2 * 0.6));
            if (num4 < 0)
            {
                num4 = 0;
            }
            ...
            for (int num41 = num4; num41 < maxTilesX; num41++)
            {
                for (int num42 = num6; num42 < maxTilesY; num42++)
                {
            ...
            for (int num43 = num4; num43 < maxTilesX; num43++)
            {
                for (int num44 = num6; num44 < maxTilesY; num44++)
                {
                    Main.tile[num43, num44].active = false;
                    Main.tile[num43, num44].wall = 0;
                }
            }
            for (int num45 = num4; num45 < maxTilesX; num45++)
            {
            ...
            {
                int num50 = 0;
                for (int num51 = num4; num51 > (num4 - 0x19); num51--)
                {
                    num50++;
            ...
            num4 += 2;
            maxTilesX -= 2;
            for (int num53 = num4; num53 < maxTilesX; num53++)
            {
                for (int num54 = num6; num54 < maxTilesY; num54++)
                {
            ...
            for (int num55 = num4; num55 < maxTilesX; num55++)
            {
                for (int num56 = num6; num56 < maxTilesY; num56++)
                {
        ...
        public static void DungeonHalls(int i, int j, int tileType, int wallType, bool forceX = false)
        {
            ...
            while (num3 > 0)
            {
                ...
                int maxTilesX = ((int) ((vector.X + num) + 4.0)) + genRand.Next(6);
                int num6 = ((int) ((vector.Y - num) - 4.0)) - genRand.Next(6);
                int maxTilesY = ((int) ((vector.Y + num) + 4.0)) + genRand.Next(6);
                if (num4 < 0)
                {
                    num4 = 0;
                }
                ...
                for (int m = num4 + 1; m < (maxTilesX - 1); m++)
                {
                    for (int num11 = num6 + 1; num11 < (maxTilesY - 1); num11++)
                    {
                ...
                maxTilesX = ((int) (vector.X + (num * 0.5))) + num12;
                num6 = ((int) (vector.Y - (num * 0.5))) - num12;
                maxTilesY = ((int) (vector.Y + (num * 0.5))) + num12;
                if (num4 < 0)
                {
                    num4 = 0;
                }
                ...
                for (int n = num4; n < maxTilesX; n++)
                {
                    for (int num14 = num6; num14 < maxTilesY; num14++)
                    {
        ...
        public static void DungeonRoom(int i, int j, int tileType, int wallType)
        {
            ...
            vector.X = i;
            vector.Y = j - (((float) num) / 2f);
            int num2 = genRand.Next(10, 20);
            double x = vector.X;
            double num4 = vector.X;
            double y = vector.Y;
            double num6 = vector.Y;
            while (num2 > 0)
            {
                num2--;
                int num7 = (int) ((vector.X - (num * 0.800000011920929)) - 5.0);
                int maxTilesX = (int) ((vector.X + (num * 0.800000011920929)) + 5.0);
                int num9 = (int) ((vector.Y - (num * 0.800000011920929)) - 5.0);
                int maxTilesY = (int) ((vector.Y + (num * 0.800000011920929)) + 5.0);
                if (num7 < 0)
                {
                    num7 = 0;
                }
                ...
                for (int k = num7; k < maxTilesX; k++)
                {
                    for (int num12 = num9; num12 < maxTilesY; num12++)
                    {
                ...
                for (int m = num7 + 1; m < (maxTilesX - 1); m++)
                {
                    for (int num14 = num9 + 1; num14 < (maxTilesY - 1); num14++)
                    {
                        PlaceWall(m, num14, wallType, true);
                    }
                }
                num7 = (int) (vector.X - (num * 0.5));
                maxTilesX = (int) (vector.X + (num * 0.5));
                num9 = (int) (vector.Y - (num * 0.5));
                maxTilesY = (int) (vector.Y + (num * 0.5));
                if (num7 < 0)
                {
                    num7 = 0;
                }
                ...
                for (int n = num7; n < maxTilesX; n++)
                {
                    for (int num16 = num9; num16 < maxTilesY; num16++)
                    {
        ...
        public static void DungeonStairs(int i, int j, int tileType, int wallType)
        {
            ...
            while (num3 > 0)
            {
                ...
                {
                    dSurface = true;
                    TileRunner(num9, ((int) ((vector.Y - num) - 6.0)) + num10, (double) genRand.Next(0x19, 0x23), genRand.Next(10, 20), -1, false, 0f, -1f, false, true);
                }
                for (int k = num4; k < maxTilesX; k++)
                {
                    for (int num12 = num6; num12 < maxTilesY; num12++)
                    {
                        Main.tile[k, num12].liquid = 0;
                ...
                for (int m = num4 + 1; m < (maxTilesX - 1); m++)
                {
                    for (int num14 = num6 + 1; num14 < (maxTilesY - 1); num14++)
                    {
                        PlaceWall(m, num14, wallType, true);
                    }
                }
                ...
                num4 = ((int) (vector.X - (num * 0.5))) - num15;
                maxTilesX = ((int) (vector.X + (num * 0.5))) + num15;
                num6 = ((int) (vector.Y - (num * 0.5))) - num15;
                maxTilesY = ((int) (vector.Y + (num * 0.5))) + num15;
                if (num4 < 0)
                {
                    num4 = 0;
                }
                ...
                for (int n = num4; n < maxTilesX; n++)
                {
                    for (int num17 = num6; num17 < maxTilesY; num17++)
                    {
        ...
        public static void FloatingIsland(int i, int j)
        {
            ...
            double num2 = num;
            float num3 = genRand.Next(20, 0x19);
            vector.X = i;
            vector.Y = j;
            ...
            while ((num > 0.0) && (num3 > 0f))
            {
                ...
                TileRunner(genRand.Next(num4 + 10, maxTilesX - 10), (int) ((vector.Y + (num2 * 0.1)) + 5.0), (double) genRand.Next(5, 10), genRand.Next(10, 15), 0, true, 0f, 2f, true, true);
                num4 = (int) (vector.X - (num * 0.4));
                maxTilesX = (int) (vector.X + (num * 0.4));
                num6 = (int) (vector.Y - (num * 0.4));
                maxTilesY = (int) (vector.Y + (num * 0.4));
                if (num4 < 0)
                {
                    num4 = 0;
                }
                ...
                for (int m = num4; m < maxTilesX; m++)
                {
                    for (int num14 = num6; num14 < maxTilesY; num14++)
                    {
                        ...
                        {
                            float num15 = Math.Abs((float) (m - vector.X));
                            float num16 = Math.Abs((float) (num14 - vector.Y)) * 2f;
                            if (Math.Sqrt((double) ((num15 * num15) + (num16 * num16))) < (num2 * 0.4))
                            {
                                Main.tile[m, num14].wall = 2;
                            }
                        }
                    }
                }
        ...
        public static void generateWorld(int seed = -1)
        {
            ...
            num3 *= genRand.Next(90, 110) * 0.005;
            ...
            Label_0222:
                if (genRand.Next(0, 7) == 0)
                {
                    goto Label_0210;
                }
            Label_0398:
                if (num3 < (Main.maxTilesY * 0.15))
                {
                    num3 = Main.maxTilesY * 0.15;
                    num2 = 0;
                }
                else if (num3 > (Main.maxTilesY * 0.3))
                {
                    num3 = Main.maxTilesY * 0.3;
                    num2 = 0;
                }
                ...
                if (num4 < (num3 + (Main.maxTilesY * 0.05)))
                {
                    num4++;
                }
                ...
                for (int num13 = (int) num3; num13 < Main.maxTilesY; num13++)
                {
                    if (num13 < num4)
                    {
            ...
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next(0, ((int) num5) + 1), (double) genRand.Next(4, 15), genRand.Next(5, 40), 1, false, 0f, 0f, false, true);
            }
            for (int num44 = 0; num44 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.0002)); num44++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num5, ((int) num6) + 1), (double) genRand.Next(4, 10), genRand.Next(5, 30), 1, false, 0f, 0f, false, true);
            }
            for (int num45 = 0; num45 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.0045)); num45++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, ((int) num8) + 1), (double) genRand.Next(2, 7), genRand.Next(2, 0x17), 1, false, 0f, 0f, false, true);
            }
            Main.statusText = "Placing dirt in the rocks...";
            for (int num46 = 0; num46 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.005)); num46++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(2, 6), genRand.Next(2, 40), 0, false, 0f, 0f, false, true);
            }
            Main.statusText = "Adding clay...";
            for (int num47 = 0; num47 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 2E-05)); num47++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next(0, (int) num5), (double) genRand.Next(4, 14), genRand.Next(10, 50), 40, false, 0f, 0f, false, true);
            }
            for (int num48 = 0; num48 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 5E-05)); num48++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num5, ((int) num6) + 1), (double) genRand.Next(8, 14), genRand.Next(15, 0x2d), 40, false, 0f, 0f, false, true);
            }
            for (int num49 = 0; num49 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 2E-05)); num49++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, ((int) num8) + 1), (double) genRand.Next(8, 15), genRand.Next(5, 50), 40, false, 0f, 0f, false, true);
            }
            ...
            for (int num53 = 0; num53 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.0015)); num53++)
            {
                ...
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, Main.maxTilesY), (double) genRand.Next(2, 5), genRand.Next(2, 20), type, false, 0f, 0f, false, true);
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, Main.maxTilesY), (double) genRand.Next(8, 15), genRand.Next(7, 30), type, false, 0f, 0f, false, true);
            }
            for (int num56 = 0; num56 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 3E-05)); num56++)
            {
                ...
                if (num8 <= Main.maxTilesY)
                {
                    ...
                    TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num5, ((int) num8) + 1), (double) genRand.Next(5, 15), genRand.Next(30, 200), num58, false, 0f, 0f, false, true);
                }
            }
            for (int num59 = 0; num59 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.00015)); num59++)
            {
                ...
                if (num8 <= Main.maxTilesY)
                {
                    ...
                    TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num8, Main.maxTilesY), (double) genRand.Next(6, 20), genRand.Next(50, 300), num61, false, 0f, 0f, false, true);
                }
            }
            int num62 = 0;
            ...
            {
                num62 = genRand.Next(0, Main.maxTilesX);
                for (int num68 = 0; num68 < num6; num68++)
                {
            ...
            {
                num62 = genRand.Next(0, Main.maxTilesX);
                for (int num70 = 0; num70 < num6; num70++)
                {
            ...
            for (int num71 = 0; num71 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.002)); num71++)
            {
                int num72 = genRand.Next(1, Main.maxTilesX - 1);
                int num73 = genRand.Next((int) num5, (int) num6);
            ...
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(2, 6), genRand.Next(2, 40), 0x3b, false, 0f, 0f, false, true);
            }
            Main.statusText = "Adding shinies...";
            for (int num114 = 0; num114 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 6E-05)); num114++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num5, (int) num6), (double) genRand.Next(3, 6), genRand.Next(2, 6), 7, false, 0f, 0f, false, true);
            }
            for (int num115 = 0; num115 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 8E-05)); num115++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, (int) num8), (double) genRand.Next(3, 7), genRand.Next(3, 7), 7, false, 0f, 0f, false, true);
            }
            for (int num116 = 0; num116 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.0002)); num116++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(4, 9), genRand.Next(4, 8), 7, false, 0f, 0f, false, true);
            }
            for (int num117 = 0; num117 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 3E-05)); num117++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num5, (int) num6), (double) genRand.Next(3, 7), genRand.Next(2, 5), 6, false, 0f, 0f, false, true);
            }
            for (int num118 = 0; num118 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 8E-05)); num118++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, (int) num8), (double) genRand.Next(3, 6), genRand.Next(3, 6), 6, false, 0f, 0f, false, true);
            }
            for (int num119 = 0; num119 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.0002)); num119++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(4, 9), genRand.Next(4, 8), 6, false, 0f, 0f, false, true);
            }
            for (int num120 = 0; num120 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 3E-05)); num120++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num6, (int) num8), (double) genRand.Next(3, 6), genRand.Next(3, 6), 9, false, 0f, 0f, false, true);
            }
            for (int num121 = 0; num121 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.00017)); num121++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(4, 9), genRand.Next(4, 8), 9, false, 0f, 0f, false, true);
            }
            for (int num122 = 0; num122 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.00017)); num122++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next(0, (int) num5), (double) genRand.Next(4, 9), genRand.Next(4, 8), 9, false, 0f, 0f, false, true);
            }
            for (int num123 = 0; num123 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.00012)); num123++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next((int) num7, Main.maxTilesY), (double) genRand.Next(4, 8), genRand.Next(4, 8), 8, false, 0f, 0f, false, true);
            }
            for (int num124 = 0; num124 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.00012)); num124++)
            {
                TileRunner(genRand.Next(0, Main.maxTilesX), genRand.Next(0, ((int) num5) - 20), (double) genRand.Next(4, 8), genRand.Next(4, 8), 8, false, 0f, 0f, false, true);
            }
            ...
            for (int num125 = 0; num125 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 0.001)); num125++)
            {
                ...
                int num127 = genRand.Next((int) num5, Main.maxTilesY - 20);
                if (num125 < numMCaves)
                {
            ...
            Label_3722:
                num139--;
            Label_372A:;
                if (((Main.tile[num137, num139].liquid > 0) || Main.tile[num137, num139].active) && (num139 > (Main.maxTilesY - 140)))
                {
                    goto Label_3722;
                }
            ...
            for (int num150 = 0; num150 < (Main.maxTilesX * 0.0004); num150++)
            {
                ...
                for (int num160 = num153; num160 < num154; num160++)
                {
                    ...
                    {
                        for (int num161 = (int) num5; num161 < (Main.worldSurface - 1.0); num161++)
                        {
                ...
                for (int num163 = num153; num163 < num154; num163++)
                {
                    ...
                    num62 = num163;
                    bool flag10 = false;
                    for (int num164 = (int) num5; num164 < num162; num164++)
                    {
            ...
            for (int num209 = 0; num209 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 2.5E-05)); num209++)
            {
                ...
                while (!flag12)
                {
                    if (AddLifeCrystal(genRand.Next(1, Main.maxTilesX), genRand.Next((int) (num6 + 20.0), Main.maxTilesY)))
                    {
                        flag12 = true;
                    }
                    else
            ...
            for (int num212 = 0; num212 < ((int) ((Main.maxTilesX * Main.maxTilesY) * 1.8E-05)); num212++)
            {
                ...
                while (!flag13)
                {
                    if (AddBuriedChest(genRand.Next(1, Main.maxTilesX), genRand.Next((int) (num6 + 20.0), Main.maxTilesY), 0))
                    {
                        flag13 = true;
                    }
                    else
            ...
            for (int num222 = 0; num222 < (10f * num220); num222++)
            {
                ...
                for (bool flag14 = false; !flag14; flag14 = AddBuriedChest(num223, num224, num225))
                {
                    num223 = genRand.Next(1, Main.maxTilesX);
                    for (num224 = genRand.Next(1, Main.maxTilesY - 200); (Main.tile[num223, num224].liquid < 200) || Main.tile[num223, num224].lava; num224 = genRand.Next(1, Main.maxTilesY - 200))
                    {
                        num223 = genRand.Next(1, Main.maxTilesX);
                    }
                }
            ...
            Label_5776:
                while (!flag15)
                {
                    int num230 = genRand.Next((int) num6, Main.maxTilesY - 10);
                    if (num228 > 0.93)
                    {
            ...
            for (int num247 = 0; num247 < (Main.maxTilesX * 0.002); num247++)
            {
                ...
                for (int num252 = num249; num252 < num250; num252++)
                {
                    for (int num253 = 1; num253 < (Main.worldSurface - 1.0); num253++)
                    {
                        if ((Main.tile[num252, num253].type == 1) && Main.tile[num252, num253].active)
                        {
                            Main.tile[num252, num253].type = 2;
                        }
                        if ((Main.tile[num252 + 1, num253].type == 1) && Main.tile[num252 + 1, num253].active)
                        {
                            Main.tile[num252 + 1, num253].type = 2;
                        }
                        if (!(((Main.tile[num252, num253].type != 2) || !Main.tile[num252, num253].active) || Main.tile[num252, num253 - 1].active))
                        {
                            PlaceTile(num252, num253 - 1, 0x1b, true, false, -1);
                        }
                        if (Main.tile[num252, num253].active)
                        {
                            break;
                        }
                    }
            ...
            for (int num254 = 0; num254 < (Main.maxTilesX * 0.003); num254++)
            {
                int num255 = genRand.Next(50, Main.maxTilesX - 50);
                int num256 = genRand.Next(0x19, 50);
                for (int num257 = num255 - num256; num257 < (num255 + num256); num257++)
                {
                    for (int num258 = 20; num258 < Main.worldSurface; num258++)
                    {
                        if (Main.tile[num257, num258].active)
                        {
                            if (Main.tile[num257, num258].type == 1)
                            {
                                Main.tile[num257, num258].type = 2;
                            }
                            if (Main.tile[num257, num258 + 1].type == 1)
                            {
                                Main.tile[num257, num258 + 1].type = 2;
                            }
                            break;
                        }
                    }
                ...
                {
                    for (int num260 = 20; num260 < Main.worldSurface; num260++)
                    {
                        GrowEpicTree(num259, num260);
                    }
                }
            }
            AddTrees();
            ...
            AddPlants();
            for (int num261 = 0; num261 < Main.maxTilesX; num261++)
            {
                for (int num262 = (int) Main.worldSurface; num262 < Main.maxTilesY; num262++)
                {
                    if (Main.tile[num261, num262].active)
                    {
                        if ((Main.tile[num261, num262].type == 70) && !Main.tile[num261, num262 - 1].active)
                        {
                            GrowShroom(num261, num262);
                            if (!Main.tile[num261, num262 - 1].active)
                            {
                                PlaceTile(num261, num262 - 1, 0x47, true, false, -1);
                            }
                        }
                        if (!((Main.tile[num261, num262].type != 60) || Main.tile[num261, num262 - 1].active))
                        {
                            PlaceTile(num261, num262 - 1, 0x3d, true, false, -1);
                        }
                    }
                }
            }
            ...
            {
                int num264 = 0;
                for (int num265 = 0; num265 < Main.worldSurface; num265++)
                {
                    if (!((num264 <= 0) || Main.tile[num263, num265].active))
                    {
                        Main.tile[num263, num265].active = true;
                        Main.tile[num263, num265].type = 0x34;
                        num264--;
                    }
                    else
                    {
                    ...
                    if ((Main.tile[num263, num265].active && (Main.tile[num263, num265].type == 2)) && (genRand.Next(5) < 3))
                    {
                        num264 = genRand.Next(1, 10);
                    }
                }
                num264 = 0;
                for (int num266 = (int) Main.worldSurface; num266 < Main.maxTilesY; num266++)
                {
                    if (!((num264 <= 0) || Main.tile[num263, num266].active))
                    {
                        Main.tile[num263, num266].active = true;
                        Main.tile[num263, num266].type = 0x3e;
                        num264--;
                    }
                    else
                    {
                    ...
                    if ((Main.tile[num263, num266].active && (Main.tile[num263, num266].type == 60)) && (genRand.Next(5) < 3))
                    {
                        num264 = genRand.Next(1, 10);
                    }
                }
            ...
            for (int num267 = 0; num267 < (Main.maxTilesX * 0.005); num267++)
            {
                int num268 = genRand.Next(20, Main.maxTilesX - 20);
                int num269 = genRand.Next(5, 15);
                int num270 = genRand.Next(15, 30);
                for (int num271 = 1; num271 < (Main.worldSurface - 1.0); num271++)
                {
                    if (Main.tile[num268, num271].active)
                    {
                        for (int num272 = num268 - num269; num272 < (num268 + num269); num272++)
                        {
                            for (int num273 = num271 - num270; num273 < (num271 + num270); num273++)
                            {
                                if ((Main.tile[num272, num273].type == 3) || (Main.tile[num272, num273].type == 0x18))
                                {
                                    Main.tile[num272, num273].frameX = (short) (genRand.Next(6, 8) * 0x12);
                                }
                            }
                        }
                        break;
            ...
            for (int num274 = 0; num274 < (Main.maxTilesX * 0.002); num274++)
            {
                int num275 = genRand.Next(20, Main.maxTilesX - 20);
                int num276 = genRand.Next(4, 10);
                int num277 = genRand.Next(15, 30);
                for (int num278 = 1; num278 < (Main.worldSurface - 1.0); num278++)
                {
                    if (Main.tile[num275, num278].active)
                    {
                        for (int num279 = num275 - num276; num279 < (num275 + num276); num279++)
                        {
                            for (int num280 = num278 - num277; num280 < (num278 + num277); num280++)
                            {
                                if ((Main.tile[num279, num280].type == 3) || (Main.tile[num279, num280].type == 0x18))
                                {
                                    Main.tile[num279, num280].frameX = 0x90;
                                }
                            }
                        }
                        break;
        ...
        public static void GrowEpicTree(int i, int y)
        {
            int num;
            int num2 = y;
            while (Main.tile[i, num2].type == 20)
            {
                num2++;
            }
            if (!((((Main.tile[i, num2].active && (Main.tile[i, num2].type == 2)) && ((Main.tile[i, num2 - 1].wall == 0) && (Main.tile[i, num2 - 1].liquid == 0))) && ((Main.tile[i - 1, num2].active && (Main.tile[i - 1, num2].type == 2)) && (Main.tile[i + 1, num2].active && (Main.tile[i + 1, num2].type == 2)))) && EmptyTileCheck(i - 2, i + 2, num2 - 0x37, num2 - 1, 20)))
            {
                return;
            }
            bool flag = false;
            ...
            Label_01A9:;
                if ((((num5 == 5) || (num5 == 7)) && flag) || (((num5 == 6) || (num5 == 7)) && flag2))
                {
                    goto Label_0199;
                }
                flag = false;
            ...
            switch (num6)
            {
                case 0:
                case 1:
                    Main.tile[i + 1, num2 - 1].active = true;
                    Main.tile[i + 1, num2 - 1].type = 5;
                    switch (genRand.Next(3))
                    {
                        case 0:
                            Main.tile[i + 1, num2 - 1].frameX = 0x16;
                            Main.tile[i + 1, num2 - 1].frameY = 0x84;
                            goto Label_0C09;

                        case 1:
                            Main.tile[i + 1, num2 - 1].frameX = 0x16;
                            Main.tile[i + 1, num2 - 1].frameY = 0x9a;
                            goto Label_0C09;

                        case 2:
                            Main.tile[i + 1, num2 - 1].frameX = 0x16;
                            Main.tile[i + 1, num2 - 1].frameY = 0xb0;
                            goto Label_0C09;
                    }
                    break;
            }
        Label_0C09:
            if ((num6 == 0) || (num6 == 2))
            {
                ...
                {
                    case 0:
                        Main.tile[i - 1, num2 - 1].frameX = 0x2c;
                        Main.tile[i - 1, num2 - 1].frameY = 0x84;
                        break;
            ...
            if (num6 == 0)
            {
                ...
                {
                    case 0:
                        Main.tile[i, num2 - 1].frameX = 0x58;
                        Main.tile[i, num2 - 1].frameY = 0x84;
                        goto Label_0F51;

                    case 1:
                        Main.tile[i, num2 - 1].frameX = 0x58;
                        Main.tile[i, num2 - 1].frameY = 0x9a;
                        goto Label_0F51;

                    case 2:
                        Main.tile[i, num2 - 1].frameX = 0x58;
                        Main.tile[i, num2 - 1].frameY = 0xb0;
                        goto Label_0F51;
                }
            }
            else if (num6 == 1)
            ...
            else if (num6 == 2)
            {
                ...
                {
                    case 0:
                        Main.tile[i, num2 - 1].frameX = 0x42;
                        Main.tile[i, num2 - 1].frameY = 0x84;
                        goto Label_0F51;
        ...
        Label_0F51:
            if (genRand.Next(3) < 2)
            {
                ...
                {
                    case 0:
                        Main.tile[i, num2 - num3].frameX = 0x16;
                        Main.tile[i, num2 - num3].frameY = 0xc6;
                        goto Label_10E1;

                    case 1:
                        Main.tile[i, num2 - num3].frameX = 0x16;
                        Main.tile[i, num2 - num3].frameY = 220;
                        goto Label_10E1;

                    case 2:
                        Main.tile[i, num2 - num3].frameX = 0x16;
                        Main.tile[i, num2 - num3].frameY = 0xf2;
                        goto Label_10E1;
                }
            }
            else
            {
                ...
                {
                    case 0:
                        Main.tile[i, num2 - num3].frameX = 0;
                        Main.tile[i, num2 - num3].frameY = 0xc6;
                        goto Label_10E1;
        ...
        Label_10E1:
            RangeFrame(i - 2, (num2 - num3) - 1, i + 2, num2 + 1);
            if (Main.netMode == 2)
            {
                NetMessage.SendTileSquare(-1, i, num2 - ((int) (num3 * 0.5)), num3 + 1);
            }
        }
        ...
        public static void GrowShroom(int i, int y)
        {
            ...
            if (((!Main.tile[i - 1, num - 1].lava && !Main.tile[i - 1, num - 1].lava) && !Main.tile[i + 1, num - 1].lava) && (((Main.tile[i, num].active && (Main.tile[i, num].type == 70)) && ((Main.tile[i, num - 1].wall == 0) && Main.tile[i - 1, num].active)) && (((Main.tile[i - 1, num].type == 70) && Main.tile[i + 1, num].active) && ((Main.tile[i + 1, num].type == 70) && EmptyTileCheck(i - 2, i + 2, num - 13, num - 1, 0x47)))))
            {
                ...
                {
                    case 0:
                        Main.tile[i, num - num2].frameX = 0x24;
                        Main.tile[i, num - num2].frameY = 0;
                        break;

                    case 1:
                        Main.tile[i, num - num2].frameX = 0x24;
                        Main.tile[i, num - num2].frameY = 0x12;
                        break;

                    case 2:
                        Main.tile[i, num - num2].frameX = 0x24;
                        Main.tile[i, num - num2].frameY = 0x24;
                        break;
                }
        ...
        public static void GrowTree(int i, int y)
        {
            ...
            if ((((Main.tile[i - 1, num2 - 1].liquid != 0) || (Main.tile[i - 1, num2 - 1].liquid != 0)) || (Main.tile[i + 1, num2 - 1].liquid != 0)) || (((!Main.tile[i, num2].active || (Main.tile[i, num2].type != 2)) || ((Main.tile[i, num2 - 1].wall != 0) || !Main.tile[i - 1, num2].active)) || (((Main.tile[i - 1, num2].type != 2) || !Main.tile[i + 1, num2].active) || ((Main.tile[i + 1, num2].type != 2) || !EmptyTileCheck(i - 2, i + 2, num2 - 14, num2 - 1, 20)))))
            {
                return;
            }
            bool flag = false;
        ...
        public static void HellHouse(int i, int j)
        {
            ...
            Label_00B5:
                num5++;
            Label_00BD:;
                if ((num5 < Main.maxTilesY) && ((Main.tile[n, num5].active && (Main.tile[n, num5].type == 0x4c)) || (Main.tile[n, num5].wall == 13)))
                {
                    goto Label_00B5;
                }
            ...
            num5 = j;
        Label_01C2:;
            if ((num5 < Main.maxTilesY) && ((Main.tile[i, num5].active && (Main.tile[i, num5].type == 0x4c)) || (Main.tile[i, num5].wall == 13)))
            {
                num5++;
                goto Label_01C2;
            }
            ...
            maxValue = num5;
        Label_0370:;
            if ((Main.tile[i, num5].active && (Main.tile[i, num5].type == 0x4c)) || (Main.tile[i, num5].wall == 13))
            {
                num5--;
        ...
        public static void IslandHouse(int i, int j)
        {
            ...
            int num4 = genRand.Next(7, 12);
            int num5 = genRand.Next(5, 7);
            vector.X = i + ((num4 + 2) * num3);
            ...
            vector.X = i;
            int num7 = (int) ((vector.X - num4) - 2f);
            int maxTilesX = (int) ((vector.X + num4) + 2f);
            int num9 = (int) ((vector.Y - num5) - 2f);
            ...
            num7 = ((int) vector.X) - num4;
            maxTilesX = ((int) vector.X) + num4;
            num9 = ((int) vector.Y) - num5;
            ...
            for (int n = num7; n <= maxTilesX; n++)
            {
                for (int num14 = num9; num14 < maxTilesY; num14++)
                {
        ...
        public static void Lakinater(int i, int j)
        {
            Vector2 vector;
            Vector2 vector2;
            double num = genRand.Next(0x19, 50);
            double num2 = num;
            ...
            while ((num > 0.0) && (num3 > 0f))
            {
                ...
                for (int k = num4; k < maxTilesX; k++)
                {
                    for (int m = num6; m < maxTilesY; m++)
                    {
                        float num10 = Math.Abs((float) (k - vector.X));
                        float num11 = Math.Abs((float) (m - vector.Y));
                        if (Math.Sqrt((double) ((num10 * num10) + (num11 * num11))) < (num2 * 0.4))
                        {
        ...
        public static void loadWorld()
        {
            ...
            using (FileStream stream = new FileStream(Main.worldPathName, FileMode.Open))
            {
                using (BinaryReader reader = new BinaryReader(stream))
                {
                    try
                    {
                        ...
                        for (int j = 0; j < 0x3e8; j++)
                        {
                            if (reader.ReadBoolean())
                            {
                                ...
                                {
                                    Main.chest[j].item[num5] = new Item();
                                    byte num6 = reader.ReadByte();
                                    if (num6 > 0)
                                    {
                                        string itemName = reader.ReadString();
                                        Main.chest[j].item[num5].SetDefaults(itemName);
                                        Main.chest[j].item[num5].stack = num6;
                                    }
                                }
                            }
                        }
                        for (int k = 0; k < 0x3e8; k++)
                        {
                            if (reader.ReadBoolean())
                            {
                                ...
                                Console.WriteLine(string.Concat(new object[] { num8, ",", num9, ",", Main.tile.GetUpperBound(0), ",", Main.tile.GetUpperBound(1) }));
                                try
                                {
                                    if (Main.tile[num8, num9].active && (Main.tile[num8, num9].type == 0x37))
                                    {
                        ...
                        float num13 = 0f;
                        while ((Liquid.numLiquid > 0) && (num11 < 0x186a0))
                        {
                            num11++;
                    ...
                    {
                        Main.menuMode = 15;
                        Main.statusText = exception2.ToString();
                        loadFailed = true;
                        try
                        {
                            reader.Close();
        ...
        public static void MakeDungeon(int x, int y, int tileType = 0x29, int wallType = 7)
        {
            ...
            {
                num18++;
                int num88 = genRand.Next(dMinX, dMaxX);
                int num89 = genRand.Next(dMinY, dMaxY);
                if (Main.tile[num88, num89].wall == wallType)
                {
                    for (int num90 = num89; num90 > dMinY; num90--)
                    {
                        if (Main.tile[num88, num90 - 1].active && (Main.tile[num88, num90 - 1].type == tileType))
                        {
                            bool flag7 = false;
                            for (int num91 = num88 - 15; num91 < (num88 + 15); num91++)
                            {
                                for (int num92 = num90 - 15; num92 < (num90 + 15); num92++)
                                {
                                    if ((((num91 > 0) && (num91 < Main.maxTilesX)) && ((num92 > 0) && (num92 < Main.maxTilesY))) && (Main.tile[num91, num92].type == 0x2a))
                                    {
                                        flag7 = true;
                                        break;
                                    }
                            ...
                            if ((Main.tile[num88 - 1, num90].active || Main.tile[num88 + 1, num90].active) || ((Main.tile[num88 - 1, num90 + 1].active || Main.tile[num88 + 1, num90 + 1].active) || Main.tile[num88, num90 + 2].active))
                            {
                                flag7 = true;
                            }
                            if (!flag7)
                            {
                                Place1x2Top(num88, num90, 0x2a);
                                if (Main.tile[num88, num90].type == 0x2a)
                                {
                                    num18 = 0;
                                    num20++;
                                }
        ...
        public static void Mountinater(int i, int j)
        {
            ...
            double num = genRand.Next(80, 120);
            double num2 = num;
            float num3 = genRand.Next(40, 0x37);
            vector.X = i;
            vector.Y = j + (num3 / 2f);
            vector2.X = genRand.Next(-10, 11) * 0.1f;
            vector2.Y = genRand.Next(-20, -10) * 0.1f;
            while ((num > 0.0) && (num3 > 0f))
            {
                ...
                for (int k = num4; k < maxTilesX; k++)
                {
                    for (int m = num6; m < maxTilesY; m++)
                    {
                        float num10 = Math.Abs((float) (k - vector.X));
                        float num11 = Math.Abs((float) (m - vector.Y));
                        if (!((Math.Sqrt((double) ((num10 * num10) + (num11 * num11))) >= (num2 * 0.4)) || Main.tile[k, m].active))
                        {
        ...
        public static bool OpenDoor(int i, int j, int direction)
        {
            ...
            {
                if (Main.tile[num, k] == null)
                {
                    Main.tile[num, k] = new Tile();
                }
                if (Main.tile[num, k].active)
                {
                    if ((((Main.tile[num, k].type == 3) || (Main.tile[num, k].type == 0x18)) || ((Main.tile[num, k].type == 0x34) || (Main.tile[num, k].type == 0x3d))) || (((Main.tile[num, k].type == 0x3e) || (Main.tile[num, k].type == 0x45)) || (((Main.tile[num, k].type == 0x47) || (Main.tile[num, k].type == 0x49)) || (Main.tile[num, k].type == 0x4a))))
                    {
                        KillTile(num, k, false, false, false);
                    }
                    else
                    {
                        flag = false;
            ...
            if (flag)
            {
                ...
                Main.tile[num3, num2].active = true;
                Main.tile[num3, num2].type = 11;
                Main.tile[num3, num2].frameY = 0;
                Main.tile[num3, num2].frameX = num4;
                if (Main.tile[num3 + 1, num2] == null)
                {
                    Main.tile[num3 + 1, num2] = new Tile();
                }
                Main.tile[num3 + 1, num2].active = true;
                Main.tile[num3 + 1, num2].type = 11;
                Main.tile[num3 + 1, num2].frameY = 0;
                Main.tile[num3 + 1, num2].frameX = (short) (num4 + 0x12);
                if (Main.tile[num3, num2 + 1] == null)
                {
                    Main.tile[num3, num2 + 1] = new Tile();
                }
                Main.tile[num3, num2 + 1].active = true;
                Main.tile[num3, num2 + 1].type = 11;
                Main.tile[num3, num2 + 1].frameY = 0x12;
                Main.tile[num3, num2 + 1].frameX = num4;
                if (Main.tile[num3 + 1, num2 + 1] == null)
                {
                    Main.tile[num3 + 1, num2 + 1] = new Tile();
                }
                Main.tile[num3 + 1, num2 + 1].active = true;
                Main.tile[num3 + 1, num2 + 1].type = 11;
                Main.tile[num3 + 1, num2 + 1].frameY = 0x12;
                Main.tile[num3 + 1, num2 + 1].frameX = (short) (num4 + 0x12);
                if (Main.tile[num3, num2 + 2] == null)
                {
                    Main.tile[num3, num2 + 2] = new Tile();
                }
                Main.tile[num3, num2 + 2].active = true;
                Main.tile[num3, num2 + 2].type = 11;
                Main.tile[num3, num2 + 2].frameY = 0x24;
                Main.tile[num3, num2 + 2].frameX = num4;
                if (Main.tile[num3 + 1, num2 + 2] == null)
                {
                    Main.tile[num3 + 1, num2 + 2] = new Tile();
                }
                Main.tile[num3 + 1, num2 + 2].active = true;
                Main.tile[num3 + 1, num2 + 2].type = 11;
                Main.tile[num3 + 1, num2 + 2].frameY = 0x24;
                Main.tile[num3 + 1, num2 + 2].frameX = (short) (num4 + 0x12);
        ...
        public static bool PlaceSign(int x, int y, int type)
        {
            ...
            return false;
        Label_0371:
            if ((Main.tile[num, num2].active || Main.tile[num + 1, num2].active) || (Main.tile[num, num2 + 1].active || Main.tile[num + 1, num2 + 1].active))
            {
                return false;
            }
            int num10 = 0x24 * num3;
            for (int i = 0; i < 2; i++)
            {
                for (int m = 0; m < 2; m++)
                {
                    Main.tile[num + i, num2 + m].active = true;
                    Main.tile[num + i, num2 + m].type = (byte) type;
                    Main.tile[num + i, num2 + m].frameX = (short) (num10 + (0x12 * i));
                    Main.tile[num + i, num2 + m].frameY = (short) (0x12 * m);
                }
            }
            return true;
        }
        ...
        public static void PlantCheck(int i, int j)
        {
            ...
            {
                byte num8 = Main.tile[i + 1, j].type;
            }
            if ((((j - 1) >= 0) && (Main.tile[i, j - 1] != null)) && Main.tile[i, j - 1].active)
            {
                byte num9 = Main.tile[i, j - 1].type;
            }
            ...
            {
                byte num13 = Main.tile[i + 1, j + 1].type;
            }
                                ...
                                for (int j = 0; j < 0x3e8; j++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        for (int num5 = 0; num5 < Chest.maxItems; num5++)
                                        {
                                            ...
                                            {
                                                writer.Write(Main.chest[j].item[num5].name);
                                            }
                                        }
                                    }
                                }
        ...
        {
            Console.WriteLine("Attempting to load world...");
            loadWorld();
            if (!loadFailed)
            {
        ...
        public static void TileFrame(int i, int j, bool resetFrame = false, bool noBreak = false)
        {
            ...
            if ((((i >= 0) && (j >= 0)) && ((i < Main.maxTilesX) && (j < Main.maxTilesY))) && (Main.tile[i, j] != null))
            {
                ...
                if (type == 4)
                {
                    ...
                    else if ((((num4 >= 0) && Main.tileSolid[num4]) && !Main.tileNoAttach[num4]) || (((num4 == 5) && (num == 5)) && (num6 == 5)))
                    {
                        Main.tile[i, j].frameX = 0x16;
                    }
                        ...
                        if ((((Main.tile[num12, num13] != null) && (Main.tile[num12 + 1, num13] != null)) && ((Main.tile[num12, num13 + 1] != null) && (Main.tile[num12 + 1, num13 + 1] != null))) && (((!Main.tile[num12, num13].active || (Main.tile[num12, num13].type != type)) || (!Main.tile[num12 + 1, num13].active || (Main.tile[num12 + 1, num13].type != type))) || ((!Main.tile[num12, num13 + 1].active || (Main.tile[num12, num13 + 1].type != type)) || (!Main.tile[num12 + 1, num13 + 1].active || (Main.tile[num12 + 1, num13 + 1].type != type)))))
                        {
                            ...
                            else if (type == 0x1f)
                            {
                                ...
                                if (shadowOrbCount >= 3)
                                {
                                    ...
                                    for (int m = 0; m < 8; m++)
                                    {
                                        float num21 = Math.Abs((float) (Main.player[m].position.X - num16)) + Math.Abs((float) (Main.player[m].position.Y - num17));
        ...
        Label_14F2:
            ...
            for (int k = num29; k < (num29 + 2); k++)
            {
                for (int n = num26; n < (num26 + 3); n++)
                {
                    if (!(flag2 || ((Main.tile[k, n].type == 11) && Main.tile[k, n].active)))
                    {
                        destroyObject = true;
                        Item.NewItem(i * 0x10, j * 0x10, 0x10, 0x10, 0x19, 1, false);
                        flag2 = true;
                    ...
                    if (flag2)
                    {
                        KillTile(k, n, false, false, false);
                    }
                }
            }
            destroyObject = false;
        ...
        Label_18CF:
            ...
            if (((num > -1) && !Main.tileSolid[num]) && (num != type))
            {
                num = -1;
            }
            ...
            else if ((((num2 == type) && (num7 == num35)) && ((num4 == type) && (num5 == type))) && ((num == -1) && (num3 == -1)))
            {
                switch (frameNumber)
                {
                    case 0:
            ...
            else if ((((num2 == type) && (num7 == type)) && ((num4 == type) && (num5 == num35))) && ((num == -1) && (num6 == -1)))
            {
                switch (frameNumber)
                {
                    case 0:
        ...
        Label_4BF6:
            ...
            {
                if (((((num != type) && (num != num35)) && ((num3 == type) || (num3 == num35))) && ((num6 == type) || (num6 == num35))) && ((num8 == type) || (num8 == num35)))
                {
                    switch (frameNumber)
                    {
                        case 0:
                ...
                else if (((((num3 != type) && (num3 != num35)) && ((num == type) || (num == num35))) && ((num6 == type) || (num6 == num35))) && ((num8 == type) || (num8 == num35)))
                {
                    switch (frameNumber)
                    {
                        case 0:
                ...
                else if (((((num6 != type) && (num6 != num35)) && ((num == type) || (num == num35))) && ((num3 == type) || (num3 == num35))) && ((num8 == type) || (num8 == num35)))
                {
                    switch (frameNumber)
                    {
                        case 0:
                ...
                else if (((((num8 != type) && (num8 != num35)) && ((num == type) || (num == num35))) && ((num6 == type) || (num6 == num35))) && ((num3 == type) || (num3 == num35)))
                {
                    switch (frameNumber)
                    {
                        case 0:
        ...
        Label_4EA4:
            ...
            else if ((((num7 != num35) && (num7 != type)) && ((num2 == type) && (num4 == type))) && (((num5 != num35) && (num5 != type)) && ((num != num35) && (num != type))))
            {
                switch (frameNumber)
                {
                    case 0:
            ...
            else if (((((num7 != type) && (num7 != num35)) && ((num2 == type) && (num4 == type))) && (((num5 == type) && (num != type)) && ((num != num35) && (num3 != type)))) && (num3 != num35))
            {
                switch (frameNumber)
                {
                    case 0:
            ...
            else if (((((num5 != type) && (num5 != num35)) && ((num7 == type) && (num2 == type))) && (((num4 == type) && (num != type)) && ((num != num35) && (num6 != type)))) && (num6 != num35))
            {
                switch (frameNumber)
                {
                    case 0:
        ...
        Label_5882:
            ...
            {
                if (((num == num35) || (num == type)) && ((num3 != num35) && (num3 != type)))
                {
                    switch (frameNumber)
                    {
                        case 0:
                ...
                else if (((num3 == num35) || (num3 == type)) && ((num != num35) && (num != type)))
                {
                    switch (frameNumber)
                    {
                        case 0:
            ...
            {
                if (((num == num35) || (num == type)) && ((num6 != num35) && (num6 != type)))
                {
                    switch (frameNumber)
                    {
                        case 0:
                ...
                else if (((num6 == num35) || (num6 == type)) && ((num != num35) && (num != type)))
                {
                    switch (frameNumber)
                    {
                        case 0:
        ...
        Label_5D68:
            if (((((num2 == type) || (num2 == num35)) && ((num7 == type) || (num7 == num35))) && (((num4 == type) || (num4 == num35)) && ((num5 == type) || (num5 == num35)))) && (((num != -1) && (num3 != -1)) && ((num6 != -1) && (num8 != -1))))
            {
                switch (frameNumber)
                {
                    case 0:
        ...
        Label_5EB1:
            if ((((((type == 1) || (type == 2)) || ((type == 6) || (type == 7))) || (((type == 8) || (type == 9)) || ((type == 0x16) || (type == 0x17)))) || ((((type == 0x19) || (type == 0x25)) || ((type == 40) || (type == 0x35))) || (((type == 0x38) || (type == 0x3a)) || (((type == 0x3b) || (type == 60)) || (type == 70))))) && ((rectangle.X == -1) && (rectangle.Y == -1)))
            {
                ...
                if (((num2 == -1) || (num7 == -1)) || ((num4 == -1) || (num5 == -1)))
                {
                    ...
                    {
                        if (((num2 != -2) || (num7 != -1)) || ((num4 != type) || (num5 != type)))
                        {
                            if (((num2 != type) || (num7 != type)) || ((num4 != -1) || (num5 != -2)))
                            {
                                if (((num2 != type) || (num7 != type)) || ((num4 != -2) || (num5 != -1)))
                                {
                                    goto Label_6CFD;
                                }
                                switch (frameNumber)
                ...
                {
                    if (((num2 != type) || (num7 != -2)) || ((num4 != type) || (num5 != type)))
                    {
                        if (((num2 != type) || (num7 != type)) || ((num4 != -2) || (num5 != type)))
                        {
                            if (((num2 != type) || (num7 != type)) || ((num4 != type) || (num5 != -2)))
                            {
                                if (((num2 != -2) || (num7 != type)) || ((num4 != -2) || (num5 != type)))
                                {
                                    if (((num2 != -2) || (num7 != type)) || ((num4 != type) || (num5 != -2)))
                                    {
                                        if (((num2 != type) || (num7 != -2)) || ((num4 != -2) || (num5 != type)))
                                        {
                                            if (((num2 != type) || (num7 != -2)) || ((num4 != type) || (num5 != -2)))
                                            {
                                                if (((num2 != type) || (num7 != type)) || ((num4 != -2) || (num5 != -2)))
                                                {
                                                    if (((num2 != -2) || (num7 != -2)) || ((num4 != type) || (num5 != type)))
                                                    {
                                                        if (((num2 != -2) || (num7 != type)) || ((num4 != -2) || (num5 != -2)))
                                                        {
                                                            if (((num2 != type) || (num7 != -2)) || ((num4 != -2) || (num5 != -2)))
                                                            {
                                                                if (((num2 != -2) || (num7 != -2)) || ((num4 != type) || (num5 != -2)))
                                                                {
                                                                    if (((num2 != -2) || (num7 != -2)) || ((num4 != -2) || (num5 != type)))
                                                                    {
        ...
        Label_6CFD:
            ...
            {
                if (((num2 == -1) || (num7 == -1)) || ((num4 != type) || (num5 != -1)))
                {
                    if (((num2 != -1) || (num7 != type)) || ((num4 == -1) || (num5 == -1)))
                    {
                        if (((num2 != type) || (num7 != -1)) || ((num4 == -1) || (num5 == -1)))
                        {
                            if (((num2 == -1) || (num7 == -1)) || ((num4 != -1) || (num5 != -1)))
                            {
                                if (((num2 != -1) || (num7 != -1)) || ((num4 == -1) || (num5 == -1)))
        ...
        Label_81FB:
            ...
            if (type == 0x35)
            {
                ...
                else if (((Main.netMode == 2) && (Main.tile[i, j + 1] != null)) && !Main.tile[i, j + 1].active)
                {
                    ...
                    {
                        Main.tile[i, j].active = false;
                        int index = Projectile.NewProjectile((float) ((i * 0x10) + 8), (float) ((j * 0x10) + 8), 0f, 0.41f, 0x1f, 10, 0f, Main.myPlayer);
        ...
        public static void TileRunner(int i, int j, double strength, int steps, int type, bool addTile = false, float speedX = 0f, float speedY = 0f, bool noYChange = false, bool overRide = true)
        {
            ...
            while ((num > 0.0) && (num2 > 0f))
            {
                ...
                for (int k = num3; k < maxTilesX; k++)
                {
                    for (int m = num5; m < maxTilesY; m++)
                    {
        ...
        public static void UpdateWorld()
        {
            ...
            for (int i = 0; i < ((Main.maxTilesX * Main.maxTilesY) * num); i++)
            {
                ...
                if (Main.tile[num5, num6] != null)
                {
                    ...
                    else if (Main.tile[num5, num6].active)
                    {
                            ...
                            if ((num16 < 3) || (Main.tile[num5, num6].type == 0x17))
                            {
                                ...
                                if (!Main.tile[num14, num15].active)
                                {
                                    ...
                                    if (num16 < 2)
                                    {
                                        ...
                                        int num19 = num14 + num17;
                                        int num20 = num15 - num17;
                                        ...
                                        for (int num22 = num18; num22 < num19; num22++)
                                        {
                                            ...
                                            {
                                                if ((((((Math.Abs((int) (num22 - num14)) * 2) + Math.Abs((int) (num23 - num15))) < 9) && Main.tile[num22, num23].active) && ((Main.tile[num22, num23].type == 0x17) && Main.tile[num22, num23 - 1].active)) && ((Main.tile[num22, num23 - 1].type == 0x20) && (Main.tile[num22, num23 - 1].liquid == 0)))
                                                {
                                                    flag3 = true;
                                                    break;
                                                }
                        ...
                        {
                            bool flag4 = false;
                            for (int num24 = num6; num24 > (num6 - 10); num24--)
                            {
                                if (Main.tile[num5, num24].active && (Main.tile[num5, num24].type == 2))
                                {
                                    flag4 = true;
                                    break;
                                }
                            ...
                            if (flag4)
                            {
                                int num25 = num5;
                                int num26 = num6 + 1;
                                Main.tile[num25, num26].type = 0x34;
            ...
            for (int j = 0; j < ((Main.maxTilesX * Main.maxTilesY) * num2); j++)
            {
                ...
                int num29 = genRand.Next(((int) Main.worldSurface) + 2, Main.maxTilesY - 200);
                int num30 = num28 - 1;
                int num31 = num28 + 2;
                int num32 = num29 - 1;
                int num33 = num29 + 2;
                ...
                {
                    if (Main.tile[num28, num29].liquid > 0x20)
                    {
                        if (Main.tile[num28, num29].active && ((Main.tile[num28, num29].type == 0x3d) || (Main.tile[num28, num29].type == 0x4a)))
                        {
                            KillTile(num28, num29, false, false, false);
                            if (Main.netMode == 2)
                            {
                                NetMessage.SendData(0x11, -1, -1, "", 0, (float) num28, (float) num29, 0f);
                            }
                        }
                        continue;
                    }
                    if (Main.tile[num28, num29].active)
                    {
                        ...
                        {
                            int grass = Main.tile[num28, num29].type;
                            if (!Main.tile[num28, num32].active && (genRand.Next(10) == 0))
                            {
                                PlaceTile(num28, num32, 0x3d, true, false, -1);
                            ...
                            for (int num35 = num30; num35 < num31; num35++)
                            {
                                ...
                                {
                                    if (((num28 != num35) || (num29 != num36)) && (Main.tile[num35, num36].active && (Main.tile[num35, num36].type == 0x3b)))
                                    {
                                        SpreadGrass(num35, num36, 0x3b, grass, false);
                                        if (Main.tile[num35, num36].type == grass)
                                        {
                        ...
                        if (((Main.tile[num28, num29].type == 0x3d) && (genRand.Next(3) == 0)) && (Main.tile[num28, num29].frameX < 0x90))
                        {
                            Main.tile[num28, num29].type = 0x4a;
                            if (Main.netMode == 2)
                            {
                                NetMessage.SendTileSquare(-1, num28, num29, 3);
                            }
                        }
                        if (((Main.tile[num28, num29].type == 60) || (Main.tile[num28, num29].type == 0x3e)) && (((genRand.Next(5) == 0) && !Main.tile[num28, num29 + 1].active) && !Main.tile[num28, num29 + 1].lava))
                        {
                            bool flag6 = false;
                            for (int num37 = num29; num37 > (num29 - 10); num37--)
                            {
                                if (Main.tile[num28, num37].active && (Main.tile[num28, num37].type == 60))
                                {
                                    flag6 = true;
                                    break;
                                }
                            ...
                            if (flag6)
                            {
                                int num38 = num28;
                                int num39 = num29 + 1;
                                Main.tile[num38, num39].type = 0x3e;
                                Main.tile[num38, num39].active = true;
                                SquareTileFrame(num38, num39, true);
                                if (Main.netMode == 2)
                                {
                        ...
                        if ((Main.tile[num28, num29].type == 0x45) && (genRand.Next(3) == 0))
                        {
                            int num40 = num28;
                            int num41 = num29;
                            int num42 = 0;
                            if (Main.tile[num40 + 1, num41].active && (Main.tile[num40 + 1, num41].type == 0x45))
                            {
                                num42++;
                            }
                            if (Main.tile[num40 - 1, num41].active && (Main.tile[num40 - 1, num41].type == 0x45))
                            ...
                            if (Main.tile[num40, num41 + 1].active && (Main.tile[num40, num41 + 1].type == 0x45))
                            {
                                num42++;
                            }
                            if (Main.tile[num40, num41 - 1].active && (Main.tile[num40, num41 - 1].type == 0x45))
                            ...
                            if ((num42 < 3) || (Main.tile[num28, num29].type == 60))
                            {
                                switch (genRand.Next(4))
                                {
                                    case 0:
                                ...
                                if (!Main.tile[num40, num41].active)
                                {
                                    ...
                                    if (num42 < 2)
                                    {
                                        ...
                                        int num46 = num41 - num43;
                                        int num47 = num41 + num43;
                                        bool flag7 = false;
                                        for (int num48 = num44; num48 < num45; num48++)
                                        {
                                            for (int num49 = num46; num49 < num47; num49++)
                                            {
                                                if ((((((Math.Abs((int) (num48 - num40)) * 2) + Math.Abs((int) (num49 - num41))) < 9) && Main.tile[num48, num49].active) && ((Main.tile[num48, num49].type == 60) && Main.tile[num48, num49 - 1].active)) && ((Main.tile[num48, num49 - 1].type == 0x45) && (Main.tile[num48, num49 - 1].liquid == 0)))
                                                {
                                                    flag7 = true;
                                                    break;
                                                }
                                        ...
                                        if (flag7)
                                        {
                                            Main.tile[num40, num41].type = 0x45;
                                            Main.tile[num40, num41].active = true;
                                            SquareTileFrame(num40, num41, true);
                                            if (Main.netMode == 2)
                                            {
                                                NetMessage.SendTileSquare(-1, num40, num41, 3);
                                            }
                                        }
                                    }
                                }
                        ...
                        {
                            int num50 = Main.tile[num28, num29].type;
                            if (!Main.tile[num28, num32].active && (genRand.Next(10) == 0))
                            {
                                PlaceTile(num28, num32, 0x47, true, false, -1);
                                if ((Main.netMode == 2) && Main.tile[num28, num32].active)
                                {
                                    NetMessage.SendTileSquare(-1, num28, num32, 1);
                                }
                            ...
                            bool flag8 = false;
                            for (int num51 = num30; num51 < num31; num51++)
                            {
                                for (int num52 = num32; num52 < num33; num52++)
                                {
                                    if (((num28 != num51) || (num29 != num52)) && (Main.tile[num51, num52].active && (Main.tile[num51, num52].type == 0x3b)))
                                    {
                                        SpreadGrass(num51, num52, 0x3b, num50, false);
                                        if (Main.tile[num51, num52].type == num50)
                                        {
            ...
            if (!Main.dayTime)
            {
                float num53 = Main.maxTilesX / 0x1068;
                if (Main.rand.Next(0x1f40) < (10f * num53))
                {
                    int num54 = 12;
                    int num55 = Main.rand.Next(Main.maxTilesX - 50) + 100;
                    num55 *= 0x10;
                    int num56 = Main.rand.Next((int) (Main.maxTilesY * 0.05)) * 0x10;
                    Vector2 vector = new Vector2((float) num55, (float) num56);
                    float speedX = Main.rand.Next(-100, 0x65);
                    float speedY = Main.rand.Next(200) + 100;
                    float num59 = (float) Math.Sqrt((double) ((speedX * speedX) + (speedY * speedY)));
                    num59 = ((float) num54) / num59;
                    speedX *= num59;
                    speedY *= num59;
