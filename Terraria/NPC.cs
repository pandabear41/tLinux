    ...
    public class NPC
    {
        ...
        public void AI()
        {
            ...
            if (this.aiStyle == 3)
            {
                ...
                if (((this.position.X == this.oldPosition.X) || (this.ai[3] >= num4)) || flag3)
                {
                    this.ai[3]++;
                }
                ...
                if ((((!Main.dayTime || (this.position.Y > (Main.worldSurface * 16.0))) || ((this.type == 0x1a) || (this.type == 0x1b))) || ((this.type == 0x1c) || (this.type == 0x1f))) && (this.ai[3] < num4))
                {
            ...
            if (this.aiStyle == 4)
            {
                ...
                float num7 = ((this.position.X + (this.width / 2)) - Main.player[this.target].position.X) - (Main.player[this.target].width / 2);
                float num8 = (((this.position.Y + this.height) - 59f) - Main.player[this.target].position.Y) - (Main.player[this.target].height / 2);
                ...
                {
                    color = new Color();
                    int num11 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + (this.height * 0.25f)), this.width, (int) (this.height * 0.5f), 5, this.velocity.X, 2f, 0, color, 1f);
                ...
                if (!Main.dayTime && !dead)
                {
                        ...
                        if ((this.ai[0] != 1f) && (this.ai[0] != 2f))
                        {
                            ...
                            if (this.ai[1] != 0f)
                            {
                                if (this.ai[1] == 1f)
                                {
                                    ...
                                    float num14 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector.Y;
                                    float num15 = (float) Math.Sqrt((double) ((num13 * num13) + (num14 * num14)));
                                    num15 = num12 / num15;
                                    this.velocity.X = num13 * num15;
                                    this.velocity.Y = num14 * num15;
                                    this.ai[1] = 2f;
                                }
                            ...
                            else
                            {
                                ...
                                float num18 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector2.X;
                                float num19 = ((Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - 120f) - vector2.Y;
                                ...
                                {
                                    this.velocity.X += num17;
                                    if ((this.velocity.X < 0f) && (num18 > 0f))
                                    {
                                        this.velocity.X += num17;
                                    }
                                }
                                else if (this.velocity.X > num18)
                                {
                                    this.velocity.X -= num17;
                                    if ((this.velocity.X > 0f) && (num18 < 0f))
                                    {
                                ...
                                if (this.velocity.Y < num19)
                                {
                                    ...
                                    if ((this.velocity.Y < 0f) && (num19 > 0f))
                                    {
                                        this.velocity.Y += num17;
                                    }
                                }
                    ...
                    else
                    {
                        if (this.ai[1] == 0f)
                        {
                            ...
                            float num25 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector3.X;
                            float num26 = ((Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - 200f) - vector3.Y;
                            ...
                            if (this.velocity.X < num25)
                            {
                                ...
                                if ((this.velocity.X < 0f) && (num25 > 0f))
                                {
                                    this.velocity.X += num24;
                                }
                            }
                            else if (this.velocity.X > num25)
                            {
                                this.velocity.X -= num24;
                                if ((this.velocity.X > 0f) && (num25 < 0f))
                                {
                            ...
                            if (this.velocity.Y < num26)
                            {
                                ...
                                if ((this.velocity.Y < 0f) && (num26 > 0f))
                                {
                                    this.velocity.Y += num24;
                                }
                            }
                            else if (this.velocity.Y > num26)
                            {
                                this.velocity.Y -= num24;
                                if ((this.velocity.Y > 0f) && (num26 < 0f))
                                {
                            ...
                            else if (((this.position.Y + this.height) < Main.player[this.target].position.Y) && (num28 < 500f))
                            {
                                ...
                                if (this.ai[3] >= 90f)
                                {
                                    ...
                                    this.rotation = num9;
                                    float num29 = 5f;
                                    float num30 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector3.X;
                                    float num31 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector3.Y;
                                    float num32 = (float) Math.Sqrt((double) ((num30 * num30) + (num31 * num31)));
                                    num32 = num29 / num32;
                                    Vector2 position = vector3;
                                    vector4.X = num30 * num32;
                                    vector4.Y = num31 * num32;
                                    position.X += vector4.X * 10f;
                                    position.Y += vector4.Y * 10f;
                                    if (Main.netMode != 1)
                                    {
                                        int num33 = NewNPC((int) position.X, (int) position.Y, 5, 0);
                                        Main.npc[num33].velocity.X = vector4.X;
                                        Main.npc[num33].velocity.Y = vector4.Y;
                                        if ((Main.netMode == 2) && (num33 < 0x3e8))
                                        {
                                            NetMessage.SendData(0x17, -1, -1, "", num33, 0f, 0f, 0f);
                                        }
                                    }
                                    ...
                                    {
                                        color = new Color();
                                        Dust.NewDust(position, 20, 20, 5, vector4.X * 0.4f, vector4.Y * 0.4f, 0, color, 1f);
                                    }
                                }
                            }
                        }
                        else if (this.ai[1] == 1f)
                        {
                            ...
                            float num36 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector6.X;
                            float num37 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector6.Y;
                            float num38 = (float) Math.Sqrt((double) ((num36 * num36) + (num37 * num37)));
                            num38 = num35 / num38;
                            this.velocity.X = num36 * num38;
                            this.velocity.Y = num37 * num38;
                            this.ai[1] = 2f;
                        }
                        else if (this.ai[1] == 2f)
                        {
            ...
            if (this.aiStyle == 5)
            {
                ...
                float num41 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector7.X;
                float num42 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector7.Y;
                ...
                if (Main.player[this.target].dead)
                {
                    num41 = (this.direction * num39) / 2f;
                    num42 = -num39 / 2f;
                }
                if (this.velocity.X < num41)
                {
                    this.velocity.X += num40;
                    if ((this.velocity.X < 0f) && (num41 > 0f))
                    {
                        this.velocity.X += num40;
                    }
                }
                else if (this.velocity.X > num41)
                {
                    this.velocity.X -= num40;
                    if ((this.velocity.X > 0f) && (num41 < 0f))
                    {
                ...
                if (this.velocity.Y < num42)
                {
                    this.velocity.Y += num40;
                    if ((this.velocity.Y < 0f) && (num42 > 0f))
                    {
                        this.velocity.Y += num40;
                    }
                }
                else if (this.velocity.Y > num42)
                {
                    this.velocity.Y -= num40;
                    if ((this.velocity.Y > 0f) && (num42 < 0f))
                    {
                ...
                if ((this.type == 6) || (this.type == 0x17))
                {
                    ...
                    if (this.type == 0x17)
                    {
                        int num44 = Dust.NewDust(new Vector2(this.position.X - this.velocity.X, this.position.Y - this.velocity.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, new Color(), 2f);
                    ...
                    {
                        int num45 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + (this.height * 0.25f)), this.width, (int) (this.height * 0.5f), 0x12, this.velocity.X, 2f, this.alpha, this.color, this.scale);
                        Main.dust[num45].velocity.X *= 0.5f;
                        Main.dust[num45].velocity.Y *= 0.1f;
                    }
                }
                else if (Main.rand.Next(40) == 0)
                {
                    int num46 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + (this.height * 0.25f)), this.width, (int) (this.height * 0.5f), 5, this.velocity.X, 2f, 0, new Color(), 1f);
            ...
            if (this.aiStyle == 6)
            {
                ...
                if (Main.netMode != 1)
                {
                    ...
                    if (((this.type == 13) || (this.type == 14)) || (this.type == 15))
                    {
                        ...
                        {
                            bool flag9 = true;
                            for (int num101 = 0; num101 < 0x3e8; num101++)
                            {
                                if (Main.npc[num101].active && (((Main.npc[num101].type == 13) || (Main.npc[num101].type == 14)) || (Main.npc[num101].type == 15)))
                                {
                                    flag9 = false;
                                    break;
                                }
                ...
                int num102 = ((int) (this.position.X / 16f)) - 1;
                int maxTilesX = ((int) ((this.position.X + this.width) / 16f)) + 2;
                int num104 = ((int) (this.position.Y / 16f)) - 1;
                ...
                bool flag10 = false;
                for (int num106 = num102; num106 < maxTilesX; num106++)
                {
                    for (int num107 = num104; num107 < maxTilesY; num107++)
                    {
                        if ((Main.tile[num106, num107] != null) && ((Main.tile[num106, num107].active && (Main.tileSolid[Main.tile[num106, num107].type] || (Main.tileSolidTop[Main.tile[num106, num107].type] && (Main.tile[num106, num107].frameY == 0)))) || (Main.tile[num106, num107].liquid > 0x40)))
                        {
                            Vector2 vector15;
                            vector15.X = num106 * 0x10;
                            vector15.Y = num107 * 0x10;
                            if ((((this.position.X + this.width) > vector15.X) && (this.position.X < (vector15.X + 16f))) && (((this.position.Y + this.height) > vector15.Y) && (this.position.Y < (vector15.Y + 16f))))
                            {
                                flag10 = true;
                                if ((Main.rand.Next(40) == 0) && Main.tile[num106, num107].active)
                                {
                                    WorldGen.KillTile(num106, num107, true, true, false);
                                }
                                if ((Main.netMode != 1) && (Main.tile[num106, num107].type == 2))
                                {
                                    byte type = Main.tile[num106, num107 - 1].type;
                                }
                            }
                        }
                    }
                ...
                float num111 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector16.X;
                float num112 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector16.Y;
                float num113 = (float) Math.Sqrt((double) ((num111 * num111) + (num112 * num112)));
                if (this.ai[1] > 0f)
                {
                    num111 = (Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) - vector16.X;
                    num112 = (Main.npc[(int) this.ai[1]].position.Y + (Main.npc[(int) this.ai[1]].height / 2)) - vector16.Y;
                    this.rotation = ((float) Math.Atan2((double) num112, (double) num111)) + 1.57f;
                    num113 = (float) Math.Sqrt((double) ((num111 * num111) + (num112 * num112)));
                    num113 = (num113 - this.width) / num113;
                    num111 *= num113;
                    num112 *= num113;
                    this.velocity = new Vector2();
                    this.position.X += num111;
                    this.position.Y += num112;
                }
                else
                {
                    if (!flag10)
                    {
                        ...
                        if (this.velocity.Y > num109)
                        {
                            this.velocity.Y = num109;
                        }
                        if ((Math.Abs(this.velocity.X) + Math.Abs(this.velocity.Y)) < (num109 * 0.4))
                        {
                            if (this.velocity.X < 0f)
                            {
                                this.velocity.X -= num110 * 1.1f;
                            }
                            else
                            {
                                this.velocity.X += num110 * 1.1f;
                        ...
                        else if (this.velocity.Y == num109)
                        {
                    ...
                    else
                    {
                        if (this.soundDelay == 0)
                        {
                            ...
                            this.soundDelay = (int) num114;
                            Main.PlaySound(15, (int) this.position.X, (int) this.position.Y, 1);
                        }
                        num113 = (float) Math.Sqrt((double) ((num111 * num111) + (num112 * num112)));
                        float num115 = Math.Abs(num111);
                        float num116 = Math.Abs(num112);
                        num113 = num109 / num113;
                        num111 *= num113;
                        num112 *= num113;
                        if ((((this.velocity.X > 0f) && (num111 > 0f)) || ((this.velocity.X < 0f) && (num111 < 0f))) || (((this.velocity.Y > 0f) && (num112 > 0f)) || ((this.velocity.Y < 0f) && (num112 < 0f))))
                        {
                            if (this.velocity.X < num111)
                            {
                                this.velocity.X += num110;
                        ...
                        else if (num115 > num116)
                        {
                            ...
                            if ((Math.Abs(this.velocity.X) + Math.Abs(this.velocity.Y)) < (num109 * 0.5))
                            {
                                if (this.velocity.Y > 0f)
                                {
                                    this.velocity.Y += num110;
            ...
            if (this.aiStyle == 7)
            {
                int num = (((int) this.position.X) + (this.width / 2)) / 0x10;
                int num2 = ((int) ((this.position.Y + this.height) + 1f)) / 0x10;
                bool flag = false;
                this.directionY = -1;
                if (this.direction == 0)
                {
                ...
                {
                    if (Main.player[num93].active && (Main.player[num93].talkNPC == this.whoAmI))
                    {
                        flag = true;
                        if (!(this.ai[0] == 0f))
                        {
                        ...
                        this.ai[1] = 300f;
                        this.ai[2] = 100f;
                        if ((Main.player[num93].position.X + (Main.player[num93].width / 2)) < (this.position.X + (this.width / 2)))
                        {
                            this.direction = -1;
                        }
                        else
                ...
                if ((this.type == 0x25) && (Main.netMode != 1))
                {
                    ...
                    if ((!Main.dayTime && flag) && (this.ai[3] == 0f))
                    {
                        bool flag2 = true;
                        for (int num94 = 0; num94 < 0x3e8; num94++)
                        {
                            if (Main.npc[num94].active && (Main.npc[num94].type == 0x23))
                            {
                                flag2 = false;
                                break;
                            }
                        ...
                        if (flag2)
                        {
                            int num117 = NewNPC(((int) this.position.X) + (this.width / 2), ((int) this.position.Y) + (this.height / 2), 0x23, 0);
                            Main.npc[num117].netUpdate = true;
                ...
                if ((((Main.netMode != 1) && !Main.dayTime) && ((num != this.homeTileX) || (num2 != this.homeTileY))) && !this.homeless)
                {
                    bool flag11 = true;
                    for (int num118 = 0; num118 < 2; num118++)
                    {
                        ...
                        {
                            if (Main.player[num119].active)
                            {
                                Rectangle rectangle2 = new Rectangle((int) Main.player[num119].position.X, (int) Main.player[num119].position.Y, Main.player[num119].width, Main.player[num119].height);
                ...
                if (this.ai[0] == 0f)
                {
                    ...
                    if (!Main.dayTime && !flag)
                    {
                        if (Main.netMode != 1)
                        {
                            if ((num == this.homeTileX) && (num2 == this.homeTileY))
                            {
                                if (!(this.velocity.X == 0f))
                                {
                                    this.netUpdate = true;
                    ...
                    if ((Main.netMode != 1) && (Main.dayTime || ((num == this.homeTileX) && (num2 == this.homeTileY))))
                    {
                        if ((num >= (this.homeTileX - 0x19)) && (num <= (this.homeTileX + 0x19)))
                        {
                        ...
                        {
                            if ((num < (this.homeTileX - 50)) && (this.direction == -1))
                            {
                                this.direction = 1;
                                this.netUpdate = true;
                            }
                            else if ((num > (this.homeTileX + 50)) && (this.direction == 1))
                            {
                                this.direction = -1;
                                this.netUpdate = true;
                            }
                ...
                else if (this.ai[0] == 1f)
                {
                    ...
                    {
                        if (((Main.netMode != 1) && !this.homeless) && ((num < (this.homeTileX - 0x23)) || (num > (this.homeTileX + 0x23))))
                        {
                        ...
                        if (this.velocity.Y == 0f)
                        {
                            ...
                            this.ai[2] = -1f;
                            int num120 = (int) (((this.position.X + (this.width / 2)) + (15 * this.direction)) / 16f);
                            int num121 = (int) (((this.position.Y + this.height) - 16f) / 16f);
                            if (Main.tile[num120, num121] == null)
                            {
                                Main.tile[num120, num121] = new Tile();
                            }
                            if (Main.tile[num120, num121 - 1] == null)
                            {
                                Main.tile[num120, num121 - 1] = new Tile();
                            }
                            if (Main.tile[num120, num121 - 2] == null)
                            {
                                Main.tile[num120, num121 - 2] = new Tile();
                            }
                            if (Main.tile[num120, num121 - 3] == null)
                            {
                                Main.tile[num120, num121 - 3] = new Tile();
                            }
                            if (Main.tile[num120, num121 + 1] == null)
                            {
                                Main.tile[num120, num121 + 1] = new Tile();
                            }
                            if (Main.tile[num120 + this.direction, num121 - 1] == null)
                            {
                                Main.tile[num120 + this.direction, num121 - 1] = new Tile();
                            }
                            if (Main.tile[num120 + this.direction, num121 + 1] == null)
                            {
                                Main.tile[num120 + this.direction, num121 + 1] = new Tile();
                            }
                            if ((Main.tile[num120, num121 - 2].active && (Main.tile[num120, num121 - 2].type == 10)) && ((Main.rand.Next(10) == 0) || !Main.dayTime))
                            {
                                if (Main.netMode != 1)
                                {
                                    if (WorldGen.OpenDoor(num120, num121 - 2, this.direction))
                                    {
                                        this.closeDoor = true;
                                        this.doorX = num120;
                                        this.doorY = num121 - 2;
                                        NetMessage.SendData(0x13, -1, -1, "", 0, (float) num120, (float) (num121 - 2), (float) this.direction);
                                        this.netUpdate = true;
                                        this.ai[1] += 80f;
                                    }
                                    else if (WorldGen.OpenDoor(num120, num121 - 2, -this.direction))
                                    {
                                        this.closeDoor = true;
                                        this.doorX = num120;
                                        this.doorY = num121 - 2;
                            ...
                            else
                            {
                                if (((this.velocity.X < 0f) && (this.spriteDirection == -1)) || ((this.velocity.X > 0f) && (this.spriteDirection == 1)))
                                {
                                    if ((Main.tile[num120, num121 - 2].active && Main.tileSolid[Main.tile[num120, num121 - 2].type]) && !Main.tileSolidTop[Main.tile[num120, num121 - 2].type])
                                    {
                                        if (((this.direction == 1) && !Collision.SolidTiles(num120 - 2, num120 - 1, num121 - 5, num121 - 1)) || ((this.direction == -1) && !Collision.SolidTiles(num120 + 1, num120 + 2, num121 - 5, num121 - 1)))
                                        {
                                            if (!Collision.SolidTiles(num120, num120, num121 - 5, num121 - 3))
                                            {
                                                this.velocity.Y = -6f;
                                                this.netUpdate = true;
                                            }
                                    ...
                                    else if ((Main.tile[num120, num121 - 1].active && Main.tileSolid[Main.tile[num120, num121 - 1].type]) && !Main.tileSolidTop[Main.tile[num120, num121 - 1].type])
                                    {
                                        if (((this.direction == 1) && !Collision.SolidTiles(num120 - 2, num120 - 1, num121 - 4, num121 - 1)) || ((this.direction == -1) && !Collision.SolidTiles(num120 + 1, num120 + 2, num121 - 4, num121 - 1)))
                                        {
                                            if (!Collision.SolidTiles(num120, num120, num121 - 4, num121 - 2))
                                            {
                                                this.velocity.Y = -5f;
                                                this.netUpdate = true;
                                            }
                                    ...
                                    else if ((Main.tile[num120, num121].active && Main.tileSolid[Main.tile[num120, num121].type]) && !Main.tileSolidTop[Main.tile[num120, num121].type])
                                    {
                                        if (((this.direction == 1) && !Collision.SolidTiles(num120 - 2, num120, num121 - 3, num121 - 1)) || ((this.direction == -1) && !Collision.SolidTiles(num120, num120 + 2, num121 - 3, num121 - 1)))
                                        {
                                    ...
                                    else if ((((((Main.netMode != 1) && (num >= (this.homeTileX - 0x23))) && (num <= (this.homeTileX + 0x23))) && ((!Main.tile[num120, num121 + 1].active || !Main.tileSolid[Main.tile[num120, num121 + 1].type]) && (!Main.tile[num120 - this.direction, num121 + 1].active || !Main.tileSolid[Main.tile[num120 - this.direction, num121 + 1].type]))) && ((!Main.tile[num120, num121 + 2].active || !Main.tileSolid[Main.tile[num120, num121 + 2].type]) && (!Main.tile[num120 - this.direction, num121 + 2].active || !Main.tileSolid[Main.tile[num120 - this.direction, num121 + 2].type]))) && (((!Main.tile[num120, num121 + 3].active || !Main.tileSolid[Main.tile[num120, num121 + 3].type]) && (!Main.tile[num120 - this.direction, num121 + 3].active || !Main.tileSolid[Main.tile[num120 - this.direction, num121 + 3].type])) && ((!Main.tile[num120, num121 + 4].active || !Main.tileSolid[Main.tile[num120, num121 + 4].type]) && (!Main.tile[num120 - this.direction, num121 + 4].active || !Main.tileSolid[Main.tile[num120 - this.direction, num121 + 4].type]))))
                                    {
                                        this.direction *= -1;
                                        this.velocity.X *= -1f;
                                        this.netUpdate = true;
            ...
            if (this.aiStyle != 8)
            {
                if (this.aiStyle == 9)
                {
                    if (this.target == 8)
                    {
                        ...
                        float num48 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector8.X;
                        float num49 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector8.Y;
                    ...
                    for (int num51 = 0; num51 < 2; num51++)
                    {
                        ...
                        {
                            color = new Color();
                            int num52 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 0x1b, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, color, 2f);
                            Main.dust[num52].noGravity = true;
                            Dust dust = Main.dust[num52];
                            dust.velocity = (Vector2) (dust.velocity * 0.3f);
                            Main.dust[num52].velocity.X -= this.velocity.X * 0.2f;
                            Main.dust[num52].velocity.Y -= this.velocity.Y * 0.2f;
                        }
                        else if (this.type == 0x21)
                        {
                            color = new Color();
                            int num53 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 0x1d, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, color, 2f);
                            Main.dust[num53].noGravity = true;
                            Main.dust[num53].velocity.X *= 0.3f;
                            Main.dust[num53].velocity.Y *= 0.3f;
                        }
                        else
                        {
                            color = new Color();
                            int num54 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, color, 2f);
                            Main.dust[num54].noGravity = true;
                            Main.dust[num54].velocity.X *= 0.3f;
                            Main.dust[num54].velocity.Y *= 0.3f;
                        }
                    }
                ...
                else if (this.aiStyle == 10)
                {
                    ...
                    this.rotation = ((float) Math.Atan2((double) this.velocity.Y, (double) this.velocity.X)) - 1.57f;
                    int num55 = Dust.NewDust(new Vector2(this.position.X - this.velocity.X, this.position.Y - this.velocity.Y), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, new Color(), 2f);
                    Main.dust[num55].noGravity = true;
                    Main.dust[num55].noLight = true;
                    Main.dust[num55].velocity.X *= 0.3f;
                    Main.dust[num55].velocity.Y *= 0.3f;
                }
                else if (this.aiStyle == 11)
                {
                    if ((this.ai[0] == 0f) && (Main.netMode != 1))
                    {
                        this.TargetClosest();
                        this.ai[0] = 1f;
                        int num56 = NewNPC(((int) this.position.X) + (this.width / 2), ((int) this.position.Y) + (this.height / 2), 0x24, this.whoAmI);
                        Main.npc[num56].ai[0] = -1f;
                        Main.npc[num56].ai[1] = this.whoAmI;
                        Main.npc[num56].target = this.target;
                        Main.npc[num56].netUpdate = true;
                        num56 = NewNPC(((int) this.position.X) + (this.width / 2), ((int) this.position.Y) + (this.height / 2), 0x24, this.whoAmI);
                        Main.npc[num56].ai[0] = 1f;
                        Main.npc[num56].ai[1] = this.whoAmI;
                        Main.npc[num56].ai[3] = 150f;
                        Main.npc[num56].target = this.target;
                        Main.npc[num56].netUpdate = true;
                    }
                    ...
                    else if (this.ai[1] == 1f)
                    {
                        ...
                        float num57 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector9.X;
                        float num58 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector9.Y;
                        float num59 = (float) Math.Sqrt((double) ((num57 * num57) + (num58 * num58)));
                        num59 = 2.5f / num59;
                        this.velocity.X = num57 * num59;
                        this.velocity.Y = num58 * num59;
                    }
                    else if (this.ai[1] == 2f)
                    {
                        this.damage = 0x270f;
                        ...
                        float num60 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector10.X;
                        float num61 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector10.Y;
                        float num62 = (float) Math.Sqrt((double) ((num60 * num60) + (num61 * num61)));
                        num62 = 8f / num62;
                        this.velocity.X = num60 * num62;
                        this.velocity.Y = num61 * num62;
                    }
                    ...
                    {
                        color = new Color();
                        int num63 = Dust.NewDust(new Vector2(((this.position.X + (this.width / 2)) - 15f) - (this.velocity.X * 5f), (this.position.Y + this.height) - 2f), 30, 10, 5, -this.velocity.X * 0.2f, 3f, 0, color, 2f);
                        Main.dust[num63].noGravity = true;
                        Main.dust[num63].velocity.X *= 1.3f;
                        Main.dust[num63].velocity.X += this.velocity.X * 0.4f;
                        Main.dust[num63].velocity.Y += 2f + this.velocity.Y;
                        for (int num64 = 0; num64 < 2; num64++)
                        {
                            color = new Color();
                            num63 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 120f), this.width, 60, 5, this.velocity.X, this.velocity.Y, 0, color, 2f);
                            Main.dust[num63].noGravity = true;
                            Dust dust2 = Main.dust[num63];
                            dust2.velocity -= this.velocity;
                            Main.dust[num63].velocity.Y += 5f;
                        }
                    }
                }
                else if (this.aiStyle == 12)
                {
                    ...
                    if ((this.ai[2] == 0f) || (this.ai[2] == 3f))
                    {
                        ...
                        float num65 = ((Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) - (200f * this.ai[0])) - vector11.X;
                        float num66 = (Main.npc[(int) this.ai[1]].position.Y + 230f) - vector11.Y;
                        Math.Sqrt((double) ((num65 * num65) + (num66 * num66)));
                        this.rotation = ((float) Math.Atan2((double) num66, (double) num65)) + 1.57f;
                    }
                    else if (this.ai[2] != 1f)
                    {
                        if (this.ai[2] != 2f)
                        {
                            ...
                            else
                            {
                                ...
                                float num67 = ((Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) - (200f * this.ai[0])) - vector12.X;
                                float num68 = (Main.npc[(int) this.ai[1]].position.Y + 230f) - vector12.Y;
                                ...
                                if (((this.position.X + (this.width / 2)) < ((Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) - 500f)) || ((this.position.X + (this.width / 2)) > ((Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) + 500f)))
                                {
                                    this.TargetClosest();
                                    this.ai[2] = 5f;
                                    vector12 = new Vector2(this.position.X + (this.width * 0.5f), this.position.Y + (this.height * 0.5f));
                                    num67 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector12.X;
                                    num68 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector12.Y;
                                    num69 = (float) Math.Sqrt((double) ((num67 * num67) + (num68 * num68)));
                                    num69 = 20f / num69;
                                    this.velocity.X = num67 * num69;
                                    this.velocity.Y = num68 * num69;
                                    this.netUpdate = true;
                                }
                            }
                        }
                    ...
                    else
                    {
                        ...
                        float num70 = ((Main.npc[(int) this.ai[1]].position.X + (Main.npc[(int) this.ai[1]].width / 2)) - (200f * this.ai[0])) - vector13.X;
                        float num71 = (Main.npc[(int) this.ai[1]].position.Y + 230f) - vector13.Y;
                        ...
                        if (this.position.Y < (Main.npc[(int) this.ai[1]].position.Y - 200f))
                        {
                            this.TargetClosest();
                            this.ai[2] = 2f;
                            vector13 = new Vector2(this.position.X + (this.width * 0.5f), this.position.Y + (this.height * 0.5f));
                            num70 = (Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - vector13.X;
                            num71 = (Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - vector13.Y;
                ...
                else if (this.aiStyle == 13)
                {
                    ...
                    else
                    {
                        this.TargetClosest();
                        float num73 = 0.05f;
                        Vector2 vector14 = new Vector2((this.ai[0] * 16f) + 8f, (this.ai[1] * 16f) + 8f);
                        float num74 = ((Main.player[this.target].position.X + (Main.player[this.target].width / 2)) - (this.width / 2)) - vector14.X;
                        float num75 = ((Main.player[this.target].position.Y + (Main.player[this.target].height / 2)) - (this.height / 2)) - vector14.Y;
                        ...
                        if (this.position.X < (((this.ai[0] * 16f) + 8f) + num74))
                        {
                            this.velocity.X += num73;
                            if ((this.velocity.X < 0f) && (num74 > 0f))
                            {
                                this.velocity.X += num73 * 2f;
                            }
                        }
                        else if (this.position.X > (((this.ai[0] * 16f) + 8f) + num74))
                        {
                            this.velocity.X -= num73;
                            if ((this.velocity.X > 0f) && (num74 < 0f))
                            {
                        ...
                        if (this.position.Y < (((this.ai[1] * 16f) + 8f) + num75))
                        {
                            this.velocity.Y += num73;
                            if ((this.velocity.Y < 0f) && (num75 > 0f))
                            {
                                this.velocity.Y += num73 * 2f;
                            }
                        }
                        else if (this.position.Y > (((this.ai[1] * 16f) + 8f) + num75))
                        {
                            this.velocity.Y -= num73;
                            if ((this.velocity.Y > 0f) && (num75 < 0f))
                            {
                        ...
                        if (num74 > 0f)
                        {
                            ...
                            this.rotation = (float) Math.Atan2((double) num75, (double) num74);
                        }
                        if (num74 < 0f)
                        {
                            this.spriteDirection = -1;
                            this.rotation = ((float) Math.Atan2((double) num75, (double) num74)) + 3.14f;
                        }
                        if (this.collideX)
                        {
                            this.netUpdate = true;
            ...
            if ((this.ai[2] != 0f) && (this.ai[3] != 0f))
            {
                ...
                for (int num77 = 0; num77 < 50; num77++)
                {
                    ...
                    {
                        color = new Color();
                        int num78 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1b, 0f, 0f, 100, color, (float) Main.rand.Next(1, 3));
                    ...
                    {
                        color = new Color();
                        int num79 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1d, 0f, 0f, 100, color, 2.5f);
                        Dust dust4 = Main.dust[num79];
                    ...
                    {
                        color = new Color();
                        int num80 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 2.5f);
                ...
                for (int num81 = 0; num81 < 50; num81++)
                {
                    ...
                    {
                        color = new Color();
                        int num82 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1b, 0f, 0f, 100, color, (float) Main.rand.Next(1, 3));
                    ...
                    {
                        color = new Color();
                        int num83 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 0x1d, 0f, 0f, 100, color, 2.5f);
                        Dust dust7 = Main.dust[num83];
                    ...
                    {
                        color = new Color();
                        int num84 = Dust.NewDust(new Vector2(this.position.X, this.position.Y), this.width, this.height, 6, 0f, 0f, 100, color, 2.5f);
                        Dust dust8 = Main.dust[num84];
                        dust8.velocity = (Vector2) (dust8.velocity * 3f);
            ...
            this.ai[0] = 1f;
            int num85 = ((int) Main.player[this.target].position.X) / 0x10;
            int num86 = ((int) Main.player[this.target].position.Y) / 0x10;
            int num87 = ((int) this.position.X) / 0x10;
            int num88 = ((int) this.position.Y) / 0x10;
            int num89 = 20;
            int num90 = 0;
            bool flag7 = false;
        ...
        Label_706E:
            while (!flag7 && (num90 < 100))
            {
                num90++;
                int num91 = Main.rand.Next(num85 - num89, num85 + num89);
                for (int num92 = Main.rand.Next(num86 - num89, num86 + num89); num92 < (num86 + num89); num92++)
                {
                    if (((((num92 < (num86 - 4)) || (num92 > (num86 + 4))) || ((num91 < (num85 - 4)) || (num91 > (num85 + 4)))) && (((num92 < (num88 - 1)) || (num92 > (num88 + 1))) || ((num91 < (num87 - 1)) || (num91 > (num87 + 1))))) && Main.tile[num91, num92].active)
                    {
                        bool flag8 = true;
                        if ((this.type == 0x20) && (Main.tile[num91, num92 - 1].wall == 0))
                        {
                            flag8 = false;
                        }
                        else if (Main.tile[num91, num92 - 1].lava)
                        {
                            flag8 = false;
                        }
                        if (!((!flag8 || !Main.tileSolid[Main.tile[num91, num92].type]) || Collision.SolidTiles(num91 - 1, num91 + 1, num92 - 4, num92 - 1)))
                        {
                            this.ai[1] = 20f;
                            this.ai[2] = num91;
                            this.ai[3] = num92;
        ...
        Label_9A9A:
            ...
            if (this.type == 0x1d)
            {
                if (Main.rand.Next(5) == 0)
                {
                    int num122 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 0x1b, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, new Color(), 1.5f);
            ...
            else if (this.type == 0x20)
            {
                ...
                {
                    int num123 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 0x1d, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, new Color(), 2f);
            ...
            {
                int num124 = Dust.NewDust(new Vector2(this.position.X, this.position.Y + 2f), this.width, this.height, 6, this.velocity.X * 0.2f, this.velocity.Y * 0.2f, 100, new Color(), 2f);
            ...
            if (this.type != 0x11)
            {
                ...
                if (this.type == 0x16)
                {
                    ...
                    switch (Main.rand.Next(3))
                    {
                        ...
                        case 2:
                            return "They say there is a person who will tell you how to survive in this land... oh wait. Thats me.";
                    }
                    return str;
                }
                if (this.type == 0x25)
                ...
                else if (this.type == 0x22)
                {
                    if (this.life > 0)
                    {
                        for (int num41 = 0; num41 < ((dmg / ((double) this.lifeMax)) * 50.0); num41++)
                        {
                            ...
                            Dust dust = Main.dust[num42];
                            dust.velocity = (Vector2) (dust.velocity * 2f);
                            color = new Color();
                ...
                for (int j = 0; j < 8; j++)
                {
                            ...
                            if (!Main.tile[num16, num17].active || !Main.tileSolid[Main.tile[num16, num17].type])
                            {
                                ...
                                for (int m = num17; m < Main.maxTilesY; m++)
                                {
                                    if (Main.tile[num16, m].active && Main.tileSolid[Main.tile[num16, m].type])
                                    {
                                        ...
                                        {
                                            byte num19 = Main.tile[num16, m].type;
                                            num = num16;
                                            num2 = m;
                                            flag = true;
                                        }
                                ...
                                if (flag)
                                {
                                    ...
                                    if (flag)
                                    {
                                        for (int n = num20; n < num21; n++)
                                        {
                                            ...
                                            {
                                                if (Main.tile[n, num25].active && Main.tileSolid[Main.tile[n, num25].type])
                                                {
                                                    flag = false;
                                                    break;
                                                }
                                                if (Main.tile[n, num25].lava && (num25 < (Main.maxTilesY - 200)))
                                                {
                                                    flag = false;
                                                    break;
                                                }
                    ...
                    if (flag)
                    {
                        ...
                        for (int num26 = 0; num26 < 8; num26++)
                        {
                            ...
                            {
                                Rectangle rectangle2 = new Rectangle(((((int) Main.player[num26].position.X) + (Main.player[num26].width / 2)) - (Main.screenWidth / 2)) - safeRangeX, ((((int) Main.player[num26].position.Y) + (Main.player[num26].height / 2)) - (Main.screenHeight / 2)) - safeRangeY, Main.screenWidth + (safeRangeX * 2), Main.screenHeight + (safeRangeY * 2));
                    ...
                    else if (num2 <= Main.worldSurface)
                    {
                        ...
                        if (Main.dayTime)
                        {
                            int num29 = Math.Abs((int) (num - Main.spawnTileX));
                            index = NewNPC((num * 0x10) + 8, num2 * 0x10, 1, 0);
                            if ((Main.rand.Next(3) == 0) || (num29 < 200))
                            {
                                Main.npc[index].SetDefaults("Green Slime");
                            }
                            else if ((Main.rand.Next(10) == 0) && (num29 > 400))
                            {
            ...
            for (int i = 0; i < 0x3e8; i++)
            {
                ...
                if (flag)
                {
                    ...
                    for (int num23 = 0; num23 < 8; num23++)
                    {
                        ...
                        {
                            Rectangle rectangle2 = new Rectangle(((((int) Main.player[num23].position.X) + (Main.player[num23].width / 2)) - (Main.screenWidth / 2)) - safeRangeX, ((((int) Main.player[num23].position.Y) + (Main.player[num23].height / 2)) - (Main.screenHeight / 2)) - safeRangeY, Main.screenWidth + (safeRangeX * 2), Main.screenHeight + (safeRangeY * 2));
                            if (rectangle.Intersects(rectangle2))
                            {
                                flag = false;
                            }
        ...
        public double StrikeNPC(int Damage, float knockBack, int hitDirection)
        {
            ...
            if (this.friendly)
            {
                CombatText.NewText(new Rectangle((int) this.position.X, (int) this.position.Y, this.width, this.height), new Color(0xff, 80, 90, 0xff), dmg.ToString());
            }
            else
            {
                CombatText.NewText(new Rectangle((int) this.position.X, (int) this.position.Y, this.width, this.height), new Color(0xff, 160, 80, 0xff), dmg.ToString());
            }
            if (dmg < 1.0)
            {
                return 0.0;
