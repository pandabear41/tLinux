    ...
    public class Player
    {
            ...
            if (newItem.noGrabDelay <= 0)
            {
                ...
                for (int i = num; i < 40; i++)
                {
                    ...
                    if (((this.inventory[index].type > 0) && (this.inventory[index].stack < this.inventory[index].maxStack)) && item.IsTheSameAs(this.inventory[index]))
                    {
                        ...
                        {
                            Item item2 = this.inventory[index];
        ...
        public void ItemCheck(int i)
        {
                    ...
                    if (this.inventory[this.selectedItem].useAmmo > 0)
                    {
                        for (int num18 = 0; num18 < 0x2c; num18++)
                        {
                            if ((this.inventory[num18].ammo == this.inventory[this.selectedItem].useAmmo) && (this.inventory[num18].stack > 0))
                            {
                                ...
                                Item item = this.inventory[num18];
                                item.stack--;
                                ...
                                for (int num26 = tileTargetX - 1; num26 <= (tileTargetX + 1); num26++)
                                {
                                    for (int num27 = tileTargetY - 1; num27 <= (tileTargetY + 1); num27++)
                                    {
                                        if ((liquid < 0x100) && (Main.tile[num26, num27].lava == lava))
                                        {
                                            ...
                                            tile.liquid = (byte) (tile.liquid - ((byte) num28));
            ...
            if (((this.inventory[this.selectedItem].damage >= 0) && (this.inventory[this.selectedItem].type > 0)) && (!this.inventory[this.selectedItem].noMelee && (this.itemAnimation > 0)))
            {
                ...
                bool flag7 = false;
                Rectangle rectangle4 = new Rectangle((int) this.itemLocation.X, (int) this.itemLocation.Y, Main.itemTexture[this.inventory[this.selectedItem].type].Width, Main.itemTexture[this.inventory[this.selectedItem].type].Height) {
                ...
                else
                {
                    ...
                    if (i == Main.myPlayer)
                    {
                        ...
                        if (Main.hasFocus)
                        {
                            if (!Main.chatMode && !Main.editSign)
                            {
                                ...
                                {
                                    string str = pressedKeys[n].ToString();
                                    if (str == Main.cUp)
                                    {
                                        this.controlUp = true;
                                    }
                            ...
                            {
                                if (((this.controlThrow && (this.inventory[this.selectedItem].type > 0)) && !Main.chatMode) || (!Main.playerInventory && (Main.mouseItem.type > 0)))
                                {
                                    Item item = new Item();
                                    bool flag = false;
                                ...
                                if (!Main.playerInventory)
                                {
                                    ...
                                    int num12 = (Main.mouseState.ScrollWheelValue - Main.mouseState.ScrollWheelValue) / 120;
                                    while (num12 > 9)
                                    {
                                        num12 -= 10;
                                    }
                                ...
                                {
                                    int num13 = (Main.mouseState.ScrollWheelValue - Main.mouseState.ScrollWheelValue) / 120;
                    ...
                    for (int m = 0; m < 200; m++)
                    {
                        if ((Main.item[m].active && (Main.item[m].noGrabDelay == 0)) && (Main.item[m].owner == i))
                        {
                            ...
                            if (rectangle.Intersects(new Rectangle((int) Main.item[m].position.X, (int) Main.item[m].position.Y, Main.item[m].width, Main.item[m].height)))
                            {
                            ...
                            else
                            {
                                ...
                                if (rectangle.Intersects(new Rectangle((int) Main.item[m].position.X, (int) Main.item[m].position.Y, Main.item[m].width, Main.item[m].height)) && this.ItemSpace(Main.item[m]))
                                {
                    ...
                    if ((((((this.position.X / 16f) - tileRangeX) <= Player.tileTargetX) && (((((this.position.X + this.width) / 16f) + tileRangeX) - 1f) >= Player.tileTargetX)) && ((((this.position.Y / 16f) - tileRangeY) <= Player.tileTargetY) && (((((this.position.Y + this.height) / 16f) + tileRangeY) - 2f) >= Player.tileTargetY))) && Main.tile[Player.tileTargetX, Player.tileTargetY].active)
                    {
                        ...
                        if (this.controlUseTile)
                        {
                            if (this.releaseUseTile)
                            {
                                ...
                                else if (Main.tile[Player.tileTargetX, Player.tileTargetY].type == 0x37)
                                {
                                    ...
                                    if (flag4)
                                    {
                                        if (Main.netMode == 0)
                                        {
                                            ...
                                            this.sign = num43;
                                            Main.npcChatText = Main.sign[num43].text;
                                        }
                                        else
                                        {
                                            int num44 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 0x12;
                                            int num45 = Main.tile[Player.tileTargetX, Player.tileTargetY].frameY / 0x12;
                                            while (num44 > 1)
                                            {
                                                num44 -= 2;
                                            }
                                            int number = Player.tileTargetX - num44;
                                            int num47 = Player.tileTargetY - num45;
                                            if (Main.tile[number, num47].type == 0x37)
                                            {
                                                NetMessage.SendData(0x2e, -1, -1, "", number, (float) num47, 0f, 0f);
                                            }
                                        }
                                    }
                                }
                                ...
                                {
                                    bool flag5 = false;
                                    int num48 = Player.tileTargetX - (Main.tile[Player.tileTargetX, Player.tileTargetY].frameX / 0x12);
                                    ...
                                    {
                                        if (((num48 == this.chestX) && (y == this.chestY)) && (this.chest != -1))
                                        {
                                            this.chest = -1;
                                            Main.PlaySound(11, -1, -1, 1);
                                        }
                                        ...
                                        {
                                            NetMessage.SendData(0x1f, -1, -1, "", num48, (float) y, 0f, 0f);
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        if (num50 != -1)
                                        {
                                            ...
                                            else if ((num50 != this.chest) && (this.chest == -1))
                                            {
                                                this.chest = num50;
                                                Main.playerInventory = true;
                                                Main.PlaySound(10, -1, -1, 1);
                    ...
                    if (Main.myPlayer == this.whoAmi)
                    {
                        if (this.talkNPC >= 0)
                        {
                            Rectangle rectangle2 = new Rectangle((((int) this.position.X) + (this.width / 2)) - (tileRangeX * 0x10), (((int) this.position.Y) + (this.height / 2)) - (tileRangeY * 0x10), (tileRangeX * 0x10) * 2, (tileRangeY * 0x10) * 2);
                            Rectangle rectangle3 = new Rectangle((int) Main.npc[this.talkNPC].position.X, (int) Main.npc[this.talkNPC].position.Y, Main.npc[this.talkNPC].width, Main.npc[this.talkNPC].height);
                            if ((!rectangle2.Intersects(rectangle3) || (this.chest != -1)) || !Main.npc[this.talkNPC].active)
                            {
                                if (this.chest == -1)
                                {
                                    Main.PlaySound(11, -1, -1, 1);
                        ...
                        if (this.sign >= 0)
                        {
                            Rectangle rectangle4 = new Rectangle((((int) this.position.X) + (this.width / 2)) - (tileRangeX * 0x10), (((int) this.position.Y) + (this.height / 2)) - (tileRangeY * 0x10), (tileRangeX * 0x10) * 2, (tileRangeY * 0x10) * 2);
                            Rectangle rectangle5 = new Rectangle(Main.sign[this.sign].x * 0x10, Main.sign[this.sign].y * 0x10, 0x20, 0x20);
                        ...
                        {
                            if ((Main.npc[num51].active && !Main.npc[num51].friendly) && rectangle6.Intersects(new Rectangle((int) Main.npc[num51].position.X, (int) Main.npc[num51].position.Y, Main.npc[num51].width, Main.npc[num51].height)))
                            {
                                int hitDirection = -1;
                                if ((Main.npc[num51].position.X + (Main.npc[num51].width / 2)) < (this.position.X + (this.width / 2)))
                                {
                                    hitDirection = 1;
                                }
                                this.Hurt(Main.npc[num51].damage, hitDirection, false, false);
                            }
                        }
                    ...
                    if (this.grappling[0] >= 0)
                    {
                        ...
                        float num53 = 0f;
                        float num54 = 0f;
                        for (int num55 = 0; num55 < this.grapCount; num55++)
                        {
                            num53 += Main.projectile[this.grappling[num55]].position.X + (Main.projectile[this.grappling[num55]].width / 2);
                            num54 += Main.projectile[this.grappling[num55]].position.Y + (Main.projectile[this.grappling[num55]].height / 2);
                        }
                        num53 /= (float) this.grapCount;
                        num54 /= (float) this.grapCount;
                        Vector2 vector2 = new Vector2(this.position.X + (this.width * 0.5f), this.position.Y + (this.height * 0.5f));
                        float num56 = num53 - vector2.X;
                        float num57 = num54 - vector2.Y;
                        ...
                        if (this.controlJump)
                        {
                            if (this.releaseJump)
                            {
                                ...
                                {
                                    if ((Main.projectile[num61].active && (Main.projectile[num61].owner == i)) && (Main.projectile[num61].aiStyle == 7))
                                    {
                                        Main.projectile[num61].Kill();
                                    }
                                }
                            }
                        }
                    ...
                    if (this.inventory[this.selectedItem].type == 0xba)
                    {
                        try
                        {
                            int num62 = (int) (((this.position.X + (this.width / 2)) + (6 * this.direction)) / 16f);
                            int num63 = (int) ((this.position.Y - 44f) / 16f);
                            if (Main.tile[num62, num63].liquid < 0x80)
                            {
                                if (Main.tile[num62, num63] == null)
                                {
                                    Main.tile[num62, num63] = new Tile();
                                }
                                if ((!Main.tile[num62, num63].active || !Main.tileSolid[Main.tile[num62, num63].type]) || Main.tileSolidTop[Main.tile[num62, num63].type])
                                {
                                    flag6 = false;
                                }
                            }
                        ...
                        if (!this.wet)
                        {
                            if (this.wetCount == 0)
                            {
                                ...
                                if (!flag7)
                                {
                                    ...
                                    {
                                        color = new Color();
                                        int num66 = Dust.NewDust(new Vector2(this.position.X - 6f, (this.position.Y + (this.height / 2)) - 8f), this.width + 12, 0x18, 0x21, 0f, 0f, 0, color, 1f);
                                        Main.dust[num66].velocity.Y -= 4f;
                                        Main.dust[num66].velocity.X *= 2.5f;
                                        Main.dust[num66].scale = 1.3f;
                                        Main.dust[num66].alpha = 100;
                                ...
                                else
                                {
                                    ...
                                    {
                                        color = new Color();
                                        int num68 = Dust.NewDust(new Vector2(this.position.X - 6f, (this.position.Y + (this.height / 2)) - 8f), this.width + 12, 0x18, 0x23, 0f, 0f, 0, color, 1f);
                                        Main.dust[num68].velocity.Y -= 1.5f;
                                        Main.dust[num68].velocity.X *= 2.5f;
                                        Main.dust[num68].scale = 1.3f;
                                        Main.dust[num68].alpha = 100;
                    ...
                    else if (this.wet)
                    {
                        ...
                        if (this.wetCount == 0)
                        {
                            ...
                            if (!this.lavaWet)
                            {
                                ...
                                {
                                    color = new Color();
                                    int num70 = Dust.NewDust(new Vector2(this.position.X - 6f, this.position.Y + (this.height / 2)), this.width + 12, 0x18, 0x21, 0f, 0f, 0, color, 1f);
                                    Main.dust[num70].velocity.Y -= 4f;
                                    Main.dust[num70].velocity.X *= 2.5f;
                                    Main.dust[num70].scale = 1.3f;
                                    Main.dust[num70].alpha = 100;
                            ...
                            else
                            {
                                ...
                                {
                                    color = new Color();
                                    int num72 = Dust.NewDust(new Vector2(this.position.X - 6f, (this.position.Y + (this.height / 2)) - 8f), this.width + 12, 0x18, 0x23, 0f, 0f, 0, color, 1f);
                                    Main.dust[num72].velocity.Y -= 1.5f;
                                    Main.dust[num72].velocity.X *= 2.5f;
                                    Main.dust[num72].scale = 1.3f;
                                    Main.dust[num72].alpha = 100;
