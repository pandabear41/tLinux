            ...
            else
            {
                    ...
                    else
                    {
                        ...
                        if (this.alpha <= 0)
                        {
                            ...
                            if ((this.type == 7) && (Main.myPlayer == this.owner))
                            {
                                ...
                                NetMessage.SendData(0x1b, -1, -1, "", num11, 0f, 0f, 0f);
                            }
                        }
                    }
                }
                ...
                else if (this.aiStyle == 9)
                {
                    if (this.type == 0x22)
                    {
                        ...
                        dust.velocity = (Vector2) (dust.velocity * 1.4f);
            ...
            if (this.active)
            {
                ...
                else
                {
                    ...
                    if (((this.type == 0x1c) || (this.type == 30)) || (this.type == 0x25))
                    {
                        ...
                        Gore gore = Main.gore[num25];
                        gore.velocity = (Vector2) (gore.velocity * 0.4f);
                    ...
                    else if (this.type == 0x1d)
                    {
                        ...
                        {
                            vector = new Vector2();
                            int num31 = Gore.NewGore(new Vector2((this.position.X + (this.width / 2)) - 24f, (this.position.Y + (this.height / 2)) - 24f), vector, Main.rand.Next(0x3d, 0x40));
                            Main.gore[num31].scale = 1.5f;
                            Main.gore[num31].velocity.X += 1.5f;
                            Main.gore[num31].velocity.Y += 1.5f;
                            vector = new Vector2();
                            num31 = Gore.NewGore(new Vector2((this.position.X + (this.width / 2)) - 24f, (this.position.Y + (this.height / 2)) - 24f), vector, Main.rand.Next(0x3d, 0x40));
                            Main.gore[num31].scale = 1.5f;
                            Main.gore[num31].velocity.X -= 1.5f;
                            Main.gore[num31].velocity.Y += 1.5f;
                            vector = new Vector2();
                ...
                if (this.owner == Main.myPlayer)
                {
                    if (((this.type == 0x1c) || (this.type == 0x1d)) || (this.type == 0x25))
                    {
                        ...
                        for (int num41 = num33; num41 <= maxTilesX; num41++)
                        {
                            for (int num42 = num35; num42 <= maxTilesY; num42++)
                            {
                                float num43 = Math.Abs((float) (num41 - (this.position.X / 16f)));
                                float num44 = Math.Abs((float) (num42 - (this.position.Y / 16f)));
                                if (Math.Sqrt((double) ((num43 * num43) + (num44 * num44))) < num32)
                                {
                                    bool flag2 = true;
                                    if ((Main.tile[num41, num42] != null) && Main.tile[num41, num42].active)
                                    {
                                        flag2 = false;
                                        if ((this.type == 0x1c) || (this.type == 0x25))
                                        {
                                            if (((((!Main.tileSolid[Main.tile[num41, num42].type] || Main.tileSolidTop[Main.tile[num41, num42].type]) || ((Main.tile[num41, num42].type == 0) || (Main.tile[num41, num42].type == 1))) || (((Main.tile[num41, num42].type == 2) || (Main.tile[num41, num42].type == 0x17)) || ((Main.tile[num41, num42].type == 30) || (Main.tile[num41, num42].type == 40)))) || ((((Main.tile[num41, num42].type == 6) || (Main.tile[num41, num42].type == 7)) || ((Main.tile[num41, num42].type == 8) || (Main.tile[num41, num42].type == 9))) || (((Main.tile[num41, num42].type == 10) || (Main.tile[num41, num42].type == 0x35)) || ((Main.tile[num41, num42].type == 0x36) || (Main.tile[num41, num42].type == 0x39))))) || ((((Main.tile[num41, num42].type == 0x3b) || (Main.tile[num41, num42].type == 60)) || ((Main.tile[num41, num42].type == 0x3f) || (Main.tile[num41, num42].type == 0x40))) || ((((Main.tile[num41, num42].type == 0x41) || (Main.tile[num41, num42].type == 0x42)) || ((Main.tile[num41, num42].type == 0x43) || (Main.tile[num41, num42].type == 0x44))) || ((Main.tile[num41, num42].type == 70) || (Main.tile[num41, num42].type == 0x25)))))
                                            {
                                                flag2 = true;
                                            }
                                        }
                                        ...
                                        if ((Main.tileDungeon[Main.tile[num41, num42].type] || (Main.tile[num41, num42].type == 0x1a)) || ((Main.tile[num41, num42].type == 0x3a) || (Main.tile[num41, num42].type == 0x15)))
                                        {
                                            flag2 = false;
                                        }
                                        if (flag2)
                                        {
                                            WorldGen.KillTile(num41, num42, false, false, false);
                                            if (!(Main.tile[num41, num42].active || (Main.netMode != 1)))
                                            {
                                                NetMessage.SendData(0x11, -1, -1, "", 0, (float) num41, (float) num42, 0f);
                                            }
                                        }
                                    }
                                    if ((flag2 && (Main.tile[num41, num42] != null)) && ((Main.tile[num41, num42].wall > 0) && flag))
                                    {
                                        WorldGen.KillWall(num41, num42, false);
                                        if ((Main.tile[num41, num42].wall == 0) && (Main.netMode == 1))
                                        {
                                            NetMessage.SendData(0x11, -1, -1, "", 2, (float) num41, (float) num42, 0f);
                                        }
                                    }
                                }
                            }
                    ...
                    if (this.aiStyle == 10)
                    {
                        int num46 = (((int) this.position.X) + (this.width / 2)) / 0x10;
                        int num47 = (((int) this.position.Y) + (this.width / 2)) / 0x10;
                        int type = 0;
                        int num49 = 2;
                        if (this.type == 0x1f)
                        {
                        ...
                        {
                            WorldGen.PlaceTile(num46, num47, type, false, true, -1);
                            if (Main.tile[num46, num47].active && (Main.tile[num46, num47].type == type))
                            {
                                NetMessage.SendData(0x11, -1, -1, "", 1, (float) num46, (float) num47, (float) type);
                            }
                            else
                            {
                                number = Item.NewItem((int) this.position.X, (int) this.position.Y, this.width, this.height, num49, 1, false);
                            }
                        }
                        else
                        {
